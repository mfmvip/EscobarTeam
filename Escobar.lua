...
--     This Is The 𝙎𝙊𝙐𝙍𝘾𝙀 𝙀𝙎𝘾𝙊𝘽𝘼𝙍 @TEAM_Escobar      --
...
send(chat,msg.id_,"✘ ∫ عــــــــذرآ هذا الملف ليس تابع لهذا البوت")   
return false 
end
send(chat,msg.id_,"✘ ∫ جـآٍࢪيٰ ࢪفع آلمـلف ... .")
local File = json:decode(https.request('https://api.telegram.org/bot' .. TokenBot .. '/getfile?file_id='..ID_FILE) ) 
download_to_file('https://api.telegram.org/file/bot'..TokenBot..'/'..File.result.file_path, ''..File_Name) 
else
send(chat,msg.id_,"✘ ∫ عــــــــذرآ آلمـلف ليسۧ بصيٰغـة ⏎ Json يرجى ࢪفع آلمـلف آلصحـيٰح")
end
...
print('تــمِ رفع ( '..k..' ) ادمنيه')
end
end
if v.Vips then
for k,IdVips in pairs(v.Vips) do
Devmfm:sadd(mustafa..'mfm:VipMem:'..IdGps,IdVips)  
print('تــمِ رفع ( '..k..' ) مميزين')
end
end
if v.LinkGroups then
if v.LinkGroups ~= "" then
Devmfm:set(mustafa.."mfm:Groups:Links"..IdGps,v.LinkGroups)   
print('( تــمِ وضع روابط المجموعات )')
end
end
if v.Welcomes then
if v.Welcomes ~= "" then
Devmfm:set(mustafa.."mfm:Groups:Welcomes"..IdGps,v.Welcomes)   
print('( تــمِ وضع ترحيب المجموعات )')
end
end
end
send(chat,msg.id_,"✘ ∫ تــمِ ࢪفع آلنسۧخـة بنجـآح  \n✘ ∫ تــمِ تفعــيٰل جـمـيٰع آلمـجـمـوعــآت \n✘ ∫ تــمِ استرجاع مشرفـيٰن آلمـجـمـوعــآت \n✘ ∫ تــمِ آسۧتٍࢪجـآ؏ آوآمـࢪ آلقفل وآلفتح فـيٰٰ جـمـيٰع مـجـمـوعــآت آلبـوت ")
end
...
local mfmRank = function(msg) if SudoId(msg.sender_user_id_) then mustafaTEAM  = "المطور" elseif SecondSudo(msg) then mustafaTEAM = "المطور" elseif SudoBot(msg) then mustafaTEAM = "المطور" elseif ManagerAll(msg) then mustafaTEAM = "المدير" elseif AdminAll(msg) then mustafaTEAM = "الادمن" elseif mfmConstructor(msg) then mustafaTEAM = "المنشئ" elseif BasicConstructor(msg) then mustafaTEAM = "المنشئ" elseif Constructor(msg) then mustafaTEAM = "المنشئ" elseif Manager(msg) then mustafaTEAM = "المدير" elseif Admin(msg) then mustafaTEAM = "الادمن" else mustafaTEAM = "آلَعضــوُ" end return mustafaTEAM end
function IdRank(user_id,chat_id) if tonumber(user_id) == tonumber(1538359553) then mustafaTEAM = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(911945965) then mustafaTEAM = 'مطور السورس' elseif tonumber(user_id) == tonumber(mustafa) then mustafaTEAM = 'البوت' elseif SudoId(user_id) then mustafaTEAM = 'المطور الاساسي' elseif Devmfm:sismember(mustafa..'mfm:SecondSudo:', user_id) then mustafaTEAM = 'المطور الاساسي²' elseif Devmfm:sismember(mustafa..'mfm:SudoBot:', user_id) then mustafaTEAM = Devmfm:get(mustafa.."mfm:SudoBot:Rd"..chat_id) or 'المطور' elseif Devmfm:sismember(mustafa..'mfm:ManagerAll:', user_id) then mustafaTEAM = Devmfm:get(mustafa.."mfm:Managers:Rd"..chat_id) or 'المدير العام' elseif Devmfm:sismember(mustafa..'mfm:AdminAll:', user_id) then mustafaTEAM = Devmfm:get(mustafa.."mfm:Admins:Rd"..chat_id) or 'الادمن العام' elseif Devmfm:sismember(mustafa..'mfm:VipAll:', user_id) then mustafaTEAM = Devmfm:get(mustafa.."mfm:VipMem:Rd"..chat_id) or 'المميز العام' elseif Devmfm:sismember(mustafa..'mfm:mfmConstructor:'..chat_id, user_id) then mustafaTEAM = 'منشئ آلَمـجـ̨مـۈعة' elseif Devmfm:sismember(mustafa..'mfm:BasicConstructor:'..chat_id, user_id) then mustafaTEAM = Devmfm:get(mustafa.."mfm:BasicConstructor:Rd"..chat_id) or 'المنشئ الاساسي' elseif Devmfm:sismember(mustafa..'mfm:Constructor:'..chat_id, user_id) then mustafaTEAM = Devmfm:get(mustafa.."mfm:Constructor:Rd"..chat_id) or 'المنشئ' elseif Devmfm:sismember(mustafa..'mfm:Managers:'..chat_id, user_id) then mustafaTEAM = Devmfm:get(mustafa.."mfm:Managers:Rd"..chat_id) or 'المدير' elseif Devmfm:sismember(mustafa..'mfm:Admins:'..chat_id, user_id) then mustafaTEAM = Devmfm:get(mustafa.."mfm:Admins:Rd"..chat_id) or 'الادمن' elseif Devmfm:sismember(mustafa..'mfm:VipMem:'..chat_id, user_id) then  mustafaTEAM = Devmfm:get(mustafa.."mfm:VipMem:Rd"..chat_id) or 'المميز' elseif Devmfm:sismember(mustafa..'mfm:Cleaner:'..chat_id, user_id) then  mustafaTEAM = Devmfm:get(mustafa.."mfm:Cleaner:Rd"..chat_id) or 'المنظف' else mustafaTEAM = Devmfm:get(mustafa.."mfm:mem:Rd"..chat_id) or 'آلَعضــوُ' end return mustafaTEAM end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ عــــــــذرآ عٍزْيـــــــّــزْي ⏎ ["..dp.first_name_.."](T.me/"..UserName..")".."\n"..text, 1, 'md')
return false
end
if status == "Reply" then
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ آلَعضــوُ ⏎ ["..dp.first_name_.."](T.me/"..UserName..")".."\n"..text, 1, 'md')
return false
end
if status == "ReplyBy" then
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ بّـوُآًسًــطة ⏎ ["..dp.first_name_.."](T.me/"..UserName..")".."\n"..text, 1, 'md')
return false
end
else
...
if GetInfo.ok == true then
if GetInfo.result.status == "creator" then
send(msg.chat_id_,msg.id_,'✘ ∫ مالـك آلَمـجـ̨مـۈعة')   
return false  end 
if GetInfo.result.status == "member" then
send(msg.chat_id_,msg.id_,'✘ ∫ مجرد عضــوُ هنـآ')   
return false  end
if GetInfo.result.status == 'left' then
send(msg.chat_id_,msg.id_,'✘ ∫ آلشـخـص غـيٍٰࢪ مـوجـوډ هنـآ')   
return false  end
...
send(msg.chat_id_,msg.id_,"*✘ ∫  عـليٰڪ آلآشـتٍࢪآڪ فـيٰ قنآة آلبوت *\n*✘ ∫ قنآة آلبوت  ⏎ * ["..Devmfm:get(mustafa..'Devmfm3').."]")
end
elseif data.ok then
return var
end
...
EditMsg(Chat_Id2, Msg_Id2, "*✘ ∫ لآ آسۧتطيٰع طٍࢪډ ⏎ * "..IdRank(data.sender_user_id_, data.chat_id_)) 
return false
end
...
EditMsg(Chat_Id2, Msg_Id2, "*✘ ∫ لآ آسۧتطيٰع طٍࢪډ مـشـٍࢪفـيٰٰن آلَمـجـ̨مـۈعة*") 
return false  
end
if da and da.ID and da.ID == "Ok" then
ChatKick(data.chat_id_, data.sender_user_id_)
EditMsg(Chat_Id2, Msg_Id2, "*✘ ∫ تــمِ طٍࢪډڪ مـن آلَمـجـ̨مـۈعة*") 
return false
end
end,nil)  
end
...
Devmfm:del(mustafa..'yes'..data.sender_user_id_, 'delyes')
Devmfm:del(mustafa..'no'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "✘ ∫ تــمِ الغاء امر اطردني") 
end
...
cleaner = 'المنظفـيٰن • ' else cleaner = '' end
...
EditMsg(Chat_Id2, Msg_Id2, "*✘ ∫ تــمِ تنزيلك مـن ⏎ ⥡ *\n~ ( "..constructor..''..Managers..''..admins..''..vipmem..''..cleaner..''..donky.." ) ~ \n"  ) 
else 
if IdRank(data.sender_user_id_, data.chat_id_) == 'آلَعضــوُ' then
EditMsg(Chat_Id2, Msg_Id2, "*✘ ∫ ليس لديك رتبه فـيٰ البوت ⚠️🔰*") 
else 
EditMsg(Chat_Id2, Msg_Id2, "*✘ ∫ لا آسۧتطيٰع تنزيل ⚠️🔰 ⏎ * "..IdRank(data.sender_user_id_, data.chat_id_)) 
end
end
end
if Devmfm:get(mustafa.."mfm:NewDev"..data.sender_user_id_) then
if DataText == '/setno' then
EditMsg(Chat_Id2, Msg_Id2, "✘ ∫ تــمِ الغاء امر تغير المطور الاساسي") 
...
EditMsg(Chat_Id2, Msg_Id2, "✘ ∫ المطور الجديد ⏎ ["..CatchName(dp.first_name_,15).."](tg://user?id="..dp.id_..")\n✘ ∫ تــمِ تغير المطور الاساسي بنجاح") 
end,nil)
tdcli_function ({ID = "GetUser",user_id_ = data.sender_user_id_},function(arg,dp) 
SendText(NewDev,"*✘ ∫ بّـوُآًسًــطة ⏎ * ["..CatchName(dp.first_name_,15).."](tg://user?id="..dp.id_..")\n✘ ∫ لقد اصبحت انت مطور هذا البوت",0,'md')
end,nil)
local Create = function(data, file, uglify)  
file = io.open(file, "w+")   
local serialized   
...
Devmfm:del(mustafa..'yesdel'..data.sender_user_id_, 'delyes')
Devmfm:del(mustafa..'nodel'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "*✘ ∫ تــمِ الغاء امر نزلني*") 
end
...
EditMsg(Chat_Id2, Msg_Id2, "✘ ∫ *صاحب الحظ* ⏎ ["..UserName.."]\n✘ ∫ *مبّــروُڪ لقډ ٍࢪبحـت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*")
end
if DataText == '/NoRolet' then
Devmfm:del(mustafa..'mfm:ListRolet'..data.chat_id_) 
Devmfm:del(mustafa.."mfm:NumRolet"..data.chat_id_..data.sender_user_id_) 
Devmfm:del(mustafa.."mfm:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
EditMsg(Chat_Id2, Msg_Id2, "*✘ ∫ تــمِ الغاء آللعبّــهہ 🎮 لاعادة اللعب آٍࢪسۧل الالعاب*") 
end
if DataText == '/ListRolet' then
local List = Devmfm:smembers(mustafa..'mfm:ListRolet'..data.chat_id_) 
local Text = '*✘ ∫ قآإئمـَـهہ آلآعـبيٰن ⏎ ⥡*\n┉┉┉┉ EB ┉┉┉┉\n' 
local Textt = '┉┉┉┉ EB ┉┉┉┉\n*✘ ∫ تــمِ اكتمال العدد الكلي هل انت مستعد ؟*'
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ تــمِ حذف الامر من آلَمـجـ̨مـۈعة", 1, 'html')  
else
...
if text and text:match('^'..(Devmfm:get(mustafa..'mfm:NameBot') or "اسكوبار")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(Devmfm:get(mustafa..'mfm:NameBot') or "اسكوبار")..' ','')
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ آٍࢪسۧل الامر الجديد", 1, 'html')
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ تــمِ حفظ الامر", 1, 'html')
...
t = "*✘ ∫ قآإئمـَـهہ آلآوآمـࢪ آلمـضآفة ⏎ ⥡ *\n┉┉┉┉ EB ┉┉┉┉\n"
for k,v in pairs(List) do
...
if #List == 0 then
t = "*✘ ∫ لاتوجد اوامر مضافه فـيٰ آلَمـجـ̨مـۈعة*"
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ تــمِ حذف الاوامر المضافه فـيٰ آلَمـجـ̨مـۈعة", 1, 'html')
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ آٍࢪسۧل الامر القديم", 1, 'html')
return false
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ آٍࢪسۧل الامر الذي قمت باضافته يدويا", 1, 'html')
return false
end
end
...
t = "✘ ∫ قآإئمـَـهہ آلصلآحـيٰآت آلمـضآفة ⏎ ⥡ \n┉┉┉┉ EB ┉┉┉┉\n"
for k,v in pairs(List) do
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ تــمِ حذف الصلاحيات المضافه", 1, 'html')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ آٍࢪسۧل نوع الصلاحيه \n{ عضــوُ • مميز  • ادمن  • مدير }\n✘ ∫ آٍࢪسۧل الغاء لالغاء الامر ", 1, 'html')
end
if text and text:match("^حذف صلاحيه (.*)$") and ChCheck(msg) or text and text:match("^مسح صلاحيه (.*)$") and ChCheck(msg) then 
ComdNew = text:match("^حذف صلاحيه (.*)$") or text:match("^مسح صلاحيه (.*)$")
Devmfm:del(mustafa.."Comd:New:rt:mfm:"..ComdNew..msg.chat_id_)
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ تــمِ حذف الصلاحيه", 1, 'html')
end
if Devmfm:get(mustafa.."Comd:New"..msg.chat_id_..""..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ تــمِ الغاء الامر", 1, 'html')
Devmfm:del(mustafa.."Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
if not Constructor(msg) then
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ تسۧتطيٰع اضافة صلاحية ( عضــوُ • مميز  • ادمن )\n✘ ∫ ارسال نوع الصلاحيه مره اخرى", 1, 'html')
return false
end
end
if text == "ادمن" then
if not Manager(msg) then 
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ تسۧتطيٰع اضافة صلاحية ( عضــوُ • مميز )\n✘ ∫ ارسال نوع الصلاحيه مره اخرى", 1, 'html')
return false
end
end
if text == "مميز" then
if not Admin(msg) then
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ تسۧتطيٰع اضافة صلاحية ( عضــوُ )\n✘ ∫ ارسال نوع الصلاحيه مره اخرى", 1, 'html')
return false
end
end
if text == "مدير" or text == "ادمن" or text == "مميز" or text == "عضــوُ" then
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ تــمِ اضافة الصلاحيه", 1, 'html')
Devmfm:del(mustafa.."Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ آلَعضــوُ ⏎ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'TEAM_Escobar')..')'..' ❩\n✘ ∫ تــمِ ٍࢪفعـهہ ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
...
local mrmfm = Devmfm:get(mustafa.."Comd:New:rt:mfm:"..DEV_ABBAS..msg.chat_id_)
if mrmfm == "مميز" and VipMem(msg) then
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ آلَعضــوُ ⏎ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'TEAM_Escobar')..')'..' ❩\n✘ ∫ تــمِ تنزيٰلـهہ ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
...
if mrmfm == "مميز" and VipMem(msg) then
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ آلَعضــوُ ⏎ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'TEAM_Escobar')..')'..' ❩\n✘ ∫ تــمِ ٍࢪفعـهہ ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
local mrmfm = Devmfm:get(mustafa.."Comd:New:rt:mfm:"..text1[2]..msg.chat_id_)
if mrmfm == "مميز" and VipMem(msg) then
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ آلَعضــوُ ⏎ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'TEAM_Escobar')..')'..' ❩\n✘ ∫ تــمِ تنزيٰلـهہ ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
local Sudo_Welcome = '✘ ∫ مرحبا عٍزْيـــــــّــزْي المطور \n✘ ∫ انت المطور الاساسي هنـآ \n✘ ∫ اليك ازرار سورس اسكوبار \n✘ ∫ تسۧتطيٰع التحكم بكل الاوامر فقط اضغط على الامر الذي تريد تنفـيٰذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '✘ ∫ آهـلُِآ بك مجددا عٍزْيـــــــّــزْي المطور \n✘ ∫ اليك الازرار الخاصه بتعديل وتغيير كلايش سورس اسكوبار فقط اضغط على الامر الذي تريد تنفـيٰذه'
local key = {
...
local inline = {{{text="✘ المطور .",url="t.me/"..(dp.username_ or "TEAM_Escobar")}}}
local start = Devmfm:get(mustafa.."mfm:Start:Bot")
if start then 
Start_Source = start
else
Start_Source = "✘ ∫ مرحبا انا بوت اسمي "..NameBot.."\n✘ ∫ اختصاصي حماية المجموعات\n✘ ∫ من التفليش والسبام والخخ .. . ،\n✘ ∫ تفعيلي سهل ومجانا فقط قم برفعي ادمن فـيٰ مجموعتك وآٍࢪسۧل امر ⏎ تفعيل\n✘ ∫ سيتم رفع الادمنيه والمنشئ تلقائيا"
end 
...
Dev_mfm(msg.sender_user_id_, msg.id_, 1, '✘ ∫ تــمِ ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "TEAM_Escobar")..')', 1, 'md') 
tdcli_function({ID="ForwardMessages",chat_id_=DevId,from_chat_id_= msg.sender_user_id_,message_ids_={[0]=msg.id_},disable_notification_=1,from_background_=1},function(arg,data) 
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,dp) 
if data and data.messages_ and data.messages_[0] ~= false and data.ID ~= "Error" then
if data and data.messages_ and data.messages_[0].content_.sticker_ then
SendText(DevId,'✘ ∫ تــمِ ارسال الملصق من ⏎ ⥡\n['..string.sub(dp.first_name_,0, 40)..'](tg://user?id='..dp.id_..')',0,'md') 
return false
...
local Text = '✘ ∫ آلَعضــوُ ⏎ ['..string.sub(data.first_name_,0, 40)..'](tg://user?id='..data.id_..')'..'\n✘ ∫ تــمِ حظره من التواصل'
SendText(DevId,Text,msg.id_/2097152/0.5,'md') 
Devmfm:sadd(mustafa..'mfm:Ban:Pv',data.id_)  
return false  
end 
if text == 'الغاء الحظر' or text == 'الغاء حظر' then
local Text = '✘ ∫ آلَعضــوُ ⏎ ['..string.sub(data.first_name_,0, 40)..'](tg://user?id='..data.id_..')'..'\n✘ ∫ تــمِ الغاء حظره من التواصل'
SendText(DevId,Text,msg.id_/2097152/0.5,'md') 
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ آلَعضــوُ قام بحظر البوت لا تسۧتطيٰع ارسال الرسائل له', 1, 'md')
return false  
end 
if text then
Dev_mfm(id_user, 0, 1, text, 1, "md")  
Text = '✘ ∫ تــمِ ارسال الرساله ������لى ⏎ ⥡'
elseif msg.content_.ID == 'MessageSticker' then    
sendSticker(id_user, msg.id_, 0, 1,nil, msg.content_.sticker_.sticker_.persistent_id_)   
Text = '✘ ∫ تــمِ ارسال الملصق الى ⏎ ⥡'
elseif msg.content_.ID == 'MessagePhoto' then    
sendPhoto(id_user, msg.id_, 0, 1,nil, msg.content_.photo_.sizes_[0].photo_.persistent_id_,(msg.content_.caption_ or ''))    
Text = '✘ ∫ تــمِ ارسال الصوره الى ⏎ ⥡'
elseif msg.content_.ID == 'MessageAnimation' then    
sendDocument(id_user, msg.id_, 0, 1,nil, msg.content_.animation_.animation_.persistent_id_)    
Text = '✘ ∫ تــمِ ارسال المتحركه الى ⏎ ⥡'
elseif msg.content_.ID == 'MessageVoice' then    
sendVoice(id_user, msg.id_, 0, 1,nil, msg.content_.voice_.voice_.persistent_id_)    
Text = '✘ ∫ تــمِ ارسال البصمه الى ⏎ ⥡'
end     
...
if text == 'الغاء' then   
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ الغاء حفظ كليشة الستارت', 1, 'md')
Devmfm:del(mustafa..'mfm:Start:Bots'..msg.sender_user_id_) 
return false
end
Devmfm:set(mustafa.."mfm:Start:Bot",text)  
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ حفظ كليشة الستارت', 1, 'md')
Devmfm:del(mustafa..'mfm:Start:Bots'..msg.sender_user_id_) 
return false
end
if SecondSudo(msg) then
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ آٍࢪسۧل لي كليشة الستارت الان', 1, 'md')
return false
end
if text == 'حذف رد الخاص' or text == 'حذف كليشه ستارت' or text == '⏎ حذف رد الخاص ✘' then 
Devmfm:del(mustafa..'Start:Bot') 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ حذف كليشة الستارت بنجاح', 1, 'md')
end
...
SendText(DevId,"✘ ∫ تــمِ طرد البوت من آلَمـجـ̨مـۈعة ⏎ ⥡ \n┉┉┉┉ EB ┉┉┉┉\n✘ ∫ بواسطة ⏎ "..Name.."\n✘ ∫ اسم آلَمـجـ̨مـۈعة ⏎ ["..NameChat.."]\n✘ ∫ ايدي آلَمـجـ̨مـۈعة ⏎ ⥡ \n❨ `"..msg.chat_id_.."` ❩\n┉┉┉┉ EB ┉┉┉┉\n✘ ∫ الوقت ⏎ "..os.date("%I:%M%p").."\n✘ ∫ التاريخ ⏎ "..os.date("%Y/%m/%d").."",0,'md')
end
end,nil)
end,nil)
end
...
if ChatType == 'pv' then
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ لاتسۧتطيٰع تفعيلي هنـآ يرجى اضافتي فـيٰ مجموعه اولا', 1, 'md')
return false
end
if ChatType ~= 'sp' then
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ آلَمـجـ̨مـۈعة عاديه وليست خارقه لا تسۧتطيٰع تفعيلي يرجى ان تضع سجل رسائل آلَمـجـ̨مـۈعة ضاهر وليس مخفـيٰ ومن بعدها يمكنك رفعي ادمن ثم تفعيلي', 1, 'md')
return false
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ آلَمـجـ̨مـۈعة بالتاكيد مفعله', 1, 'md')
else
if tonumber(data.member_count_) < tonumber(Devmfm:get(mustafa..'mfm:Num:Add:Bot') or 0) and not SecondSudo(msg) then
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ عدد اعضاء آلَمـجـ̨مـۈعة اقل من ⏎ *'..(Devmfm:get(mustafa..'mfm:Num:Add:Bot') or 0)..'* عضــوُ', 1, 'md')
return false
end
ReplyStatus(msg,result.id_,"ReplyBy","✘ ∫ تــمِ تفعيل آلَمـجـ̨مـۈعة "..dp.title_)  
...
SendText(DevId,"✘ ∫ تــمِ تفعيل مجموعه جديده ⏎ ⥡ \n┉┉┉┉ EB ┉┉┉┉\n✘ ∫ بواسطة ⏎ "..Name.."\n✘ ∫ موقعه فـيٰ آلَمـجـ̨مـۈعة ⏎ "..status.."\n✘ ∫ اسم آلَمـجـ̨مـۈعة ⏎ ["..NameChat.."]\n✘ ∫ عدد اعضاء آلَمـجـ̨مـۈعة ⏎ ❨ *"..NumMem.."* ❩\n✘ ∫ ايدي آلَمـجـ̨مـۈعة ⏎ ⥡ \n❨ `"..msg.chat_id_.."` ❩\n✘ ∫ رابط آلَمـجـ̨مـۈعة ⏎ ⥡\n❨ ["..LinkGroup.."] ❩\n┉┉┉┉ EB ┉┉┉┉\n✘ ∫ الوقت ⏎ "..os.date("%I:%M%p").."\n✘ ∫ التاريخ ⏎ "..os.date("%Y/%m/%d").."",0,'md')
end
end end
end,nil)
end,nil)
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ لا تسۧتطيٰع تفعيل هذه آلَمـجـ̨مـۈعة بسبب تعطيل البوت الخدمي من قبل المطور الاساسي', 1, 'md') 
end 
end 
...
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","✘ ∫ الصوره التي آٍࢪسۧلتها تــمِ منعها من آلَمـجـ̨مـۈعة")  
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
end
end
...
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","✘ ∫ المتحركه التي آٍࢪسۧلتها تــمِ منعها من آلَمـجـ̨مـۈعة")  
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
end
end
...
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","✘ ∫ الملصق الذي آٍࢪسۧلته تــمِ منعه من آلَمـجـ̨مـۈعة")  
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
return false   
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1,'✘ ∫ الكلمه ⏎ '..msg.content_.text_..' تــمِ حذفها',  1, "html")
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ الغاء حفظ الرد', 1, 'md')
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ حفظ الرد الجديد', 1, 'md') 
Devmfm:del(mustafa..'mfm:Add:GpText'..msg.sender_user_id_..''..msg.chat_id_..'')
Devmfm:del(mustafa..'DelManagerRep'..msg.chat_id_..'')
return false 
end 
...
Text = '✘ ∫ آلَعضــوُ ⏎ '..GetName..' \n✘ ∫ قام بالتكرار المحدد تــمِ طٍࢪډهہ '
...
Text = '*✘ ∫ آلَعضــوُ ⏎ * '..GetName..' \n *✘ ∫ قام بالتكرار المحدد تــمِ تقيدِه 🚫 *'
SendText(msg.chat_id_,Text,0,'md')
return false  
end  
...
Text = '*✘ ∫ آلَعضــوُ ⏎ *'..GetName..' \n*✘ ∫ قام بالتكرار المحدد تــمِ كتـمِـهہ 🤐* '
SendText(msg.chat_id_,Text,0,'md')
return false  
end
end,nil)
...
local text = text:gsub('username',(result.username_ or 'TEAM_Escobar'))
...
if Devmfm:sismember(mustafa..'mfm:Groups',msg.chat_id_) then
BotText = "مفعله فـيٰ السابق\n✘ ∫ آٍࢪسۧل ⏎ الاوامر واستمتع بالمميزيات"
else 
BotText = "مـعـطله يجب رفعي مشرف\n✘ ∫ بعد ذلك يرجى ارسال امر ⏎ تفعيل\n✘ ∫ سيتم رفع الادمنيه والمنشئ تلقائيا"
end 
local mfmText = (Devmfm:get(mustafa.."mfm:Text:BotWelcome") or "✘ ∫ مرحبا انا بوت اسمي "..NameBot.."\n✘ ∫ حالة آلَمـجـ̨مـۈعة ⏎ "..BotText.."\n┉┉┉┉ EB ┉┉┉┉")
...
local text = text:gsub('username',(msg.content_.members_[0].username_ or 'TEAM_Escobar'))
Dev_mfm(msg.chat_id_, msg.id_, 1, text, 1, 'md')
end
--        Contact         --
...
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"✘ ∫ تــمِ الغاء حفظ الرابط")       
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ حفظ الرابط بنجاح', 1, 'md')
Devmfm:del(mustafa.."mfm:Set:Groups:Links"..msg.chat_id_..""..msg.sender_user_id_) 
return false 
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ الغاء الامر', 1, 'md')
...
Dev_mfm(msg.chat_id_, msg.id_,  1, "✘ ∫ تــمِ اضافة "..numadded..' رساله', 1, 'md')
Devmfm:del('mustafaTEAM:'..mustafa..'id:user'..msg.chat_id_) 
end
end
if text and Constructor(msg) then 
...
Dev_mfm(msg.chat_id_, msg.id_,  1, "✘ ∫ تــمِ اضافة "..numadded..' نقطه', 1, 'md')
Devmfm:del('mustafaTEAM:'..mustafa..'ids:user'..msg.chat_id_)  
end
end
...
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","✘ ∫ مــمـن̀ۈع الفشار فـيٰ آلَمـجـ̨مـۈعة")  
end end
...
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","✘ ∫ مــمـن̀ۈع التكلم بالغه الفارسيه هنـآ")  
end end
if text and (text:match("ڬ") or text:match("ٺ") or text:match("چ") or text:match("ڇ") or text:match("ڿ") or text:match("ڀ") or text:match("ڎ") or text:match("ݫ") or text:match("ژ") or text:match("ڟ") or text:match("ݜ") or text:match("ڸ") or text:match("پ") or text:match("۴") or text:match("مک") or text:match("زدن") or text:match("دخترا") or text:match("دیوث") or text:match("کلیپشن") or text:match("خوششون") or text:match("میدا") or text:match("که") or text:match("بدانیم") or text:match("باید") or text:match("زناشویی") or text:match("آموزش") or text:match("راحتی") or text:match("خسته") or text:match("بیام") or text:match("بپوشم") or text:match("كرمه")) then
...
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","✘ ∫ مــمـن̀ۈع الكفر فـيٰ آلَمـجـ̨مـۈعة") 
end end
...
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","✘ ∫ مــمـن̀ۈع التكلم بالطائفـيٰه هنـآ") 
end end
if SecondSudo(msg) then
...
local BotName = (Devmfm:get(mustafa.."mfm:NameBot") or 'اسكوبار')
...
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_, "✘ ∫ تــمِ الغاء الامر")
...
send(msg.chat_id_, msg.id_, '✘ ∫ المعرف لا يوجد فـيٰه قناة')
return false  end
if data and data.type_ and data.type_.ID and data.type_.ID == 'PrivateChatInfo' then
send(msg.chat_id_, msg.id_, '✘ ∫ عــــــــذرآ لا يمكنك وضع معرف حسابات فـيٰ الاشتراك')
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_, '✘ ∫ عــــــــذرآ لا يمكنك وضع معرف مجموعه فـيٰ الاشتراك')
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == false then
if data and data.type_ and data.type_.channel_ and data.type_.channel_.ID and data.type_.channel_.status_.ID == 'ChatMemberStatusEditor' then
send(msg.chat_id_, msg.id_,'✘ ∫ البوت ادمن فـيٰ القناة \n✘ ∫ تــمِ تفعيل الاشتراك الاجباري \n✘ ∫ ايدي القناة ⏎ '..data.id_..'\n✘ ∫ معرف القناة ⏎ [@'..data.type_.channel_.username_..']')
Devmfm:set(mustafa..'Devmfm2',data.id_)
Devmfm:set(mustafa..'Devmfm3','@'..data.type_.channel_.username_)
else
send(msg.chat_id_, msg.id_,'✘ ∫ عــــــــذرآ البوت ليس ادمن فـيٰ القناة')
end
return false  
end
end,nil)
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ تــمِ حفظ كليشة المطور", 1, "md")
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ حفظ اسم البوت ', 1, 'html')
Devmfm:del(mustafa..'mfm:NameBot'..msg.sender_user_id_)
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ جلب رابط آلَمـجـ̨مـۈعة مـعـطل', 1, 'md')
end
end
if ChatType == 'sp' or ChatType == 'gp'  then
if text == 'بوت' or text == 'بوتت' then 
NameBot = (Devmfm:get(mustafa..'mfm:NameBot') or 'اسكوبار')
local mustafaTEAM = {"*لتكول بوت اسمي *"..NameBot.." 😒🔪","*اسمي القميل* "..NameBot.." 😚♥️","*عندي اسم تره 😒💔*","*صيحولي *"..NameBot.."* كافـيٰ بوت 😒🔪*","*انت البوت لك 😒💔*"} 
...
if text and text == (Devmfm:get(mustafa..'mfm:NameBot') or 'اسكوبار') then 
NameBot = (Devmfm:get(mustafa..'mfm:NameBot') or 'اسكوبار')
...
if text ==  'حذف رسائلي' and ChCheck(msg) or text ==  'مسح رسائلي' and ChCheck(msg) then Devmfm:del(mustafa..'mfm:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_) Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ حذف جميع ٍࢪسۧآئلڪ', 1, 'md') end
if text ==  'حذف نقاطي' and ChCheck(msg) or text ==  'مسح نقاطي' and ChCheck(msg) then Devmfm:del(mustafa..'mfm:GamesNumber'..msg.chat_id_..msg.sender_user_id_) Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ حذف جميع نقآطڪ', 1, 'md') end
...
name = string.gsub(name,'🎚','🎚')
name = string.gsub(name,'☎️','☎️')
mustafaTEAM = '*✘ ∫ آول وآحـډ يٰډز هذآ آلسۧمـآيٰل يٍٰࢪبح ⏎ *'..name
...
mustafaTEAM = '*✘ ∫ مبّــروُڪ لقډ ٍࢪبحـت فـيٰ آللعبّــهہ 🎮 \n✘ ∫ آٍࢪسۧل ⏎ سۧمـآيٰلات للعـب مـٍࢪهہ اۣخࢪى 🕹*'
Dev_mfm(msg.chat_id_, msg.id_, 1,mustafaTEAM, 1, 'md')
...
if not Devmfm:get(mustafa..'mfm:Lock:Games'..msg.chat_id_) then
Devmfm2 = {'سحور','سياره','استقبال','قنفه','ايفون','بزونه','مطبخ','كرستيانو','دجاجه','مدرسه','الوان','غرفه','ثلاجه','كهوه','سفـيٰنه','العراق','محطه','طياره','رادار','منزل','مستشفى','كهرباء','تفاحه','اخطبوط','سلمون','فرنسا','برتقاله','تفاح','مطرقه','بتيته','لهانه','شباك','باص','سمكه','ذباب','تلفاز','حاسوب','انترنيت','ساحه','جسر'};
name = Devmfm2[math.random(#Devmfm2)]
Devmfm:set(mustafa..'mfm:GameNum'..msg.chat_id_,name)
Devmfm:del(mustafa..'mfm:Games:Ids'..msg.chat_id_)
...
name = string.gsub(name,'سفـيٰنه','ه ن ف ي س')
...
mustafaTEAM = '✘ ∫ اول وآحـډ يرتبها يٍٰࢪبح ⏎ '..name
Dev_mfm(msg.chat_id_, msg.id_, 1,mustafaTEAM, 1, 'md')
return false
end end
if text == Devmfm:get(mustafa..'mfm:GameNum'..msg.chat_id_) and not Devmfm:get(mustafa..'mfm:Games:Ids'..msg.chat_id_) then
if not Devmfm:get(mustafa..'mfm:Games:Ids'..msg.chat_id_) then 
mustafaTEAM = '✘ ∫ مبّــروُڪ لقډ ٍࢪبحـت فـيٰ آللعبّــهہ 🎮 \n✘ ∫ آٍࢪسۧل ⏎ ترتيب للعـب مـٍࢪهہ اۣخࢪى 🕹'
Dev_mfm(msg.chat_id_, msg.id_, 1,mustafaTEAM, 1, 'md')
Devmfm:incrby(mustafa..'mfm:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
end
Devmfm:set(mustafa..'mfm:Games:Ids'..msg.chat_id_,true)
...
name = string.gsub(name,'السمك','ما هو الحيوان الذي لم يصعد الى سفـيٰنة نوح عليه السلام ؟')
...
name = string.gsub(name,'بيت الشعر','ما هو البيت الذي ليس فـيٰه ابواب ولا نوافذ ؟ ')
name = string.gsub(name,'لهانه','وحده حلوه ومغروره تلبس مية تنوره .من هيه ؟ ')
name = string.gsub(name,'انا','ابن امك وابن ابيك وليس باختك ولا باخيك فمن يكون ؟')
name = string.gsub(name,'امي','اخت خالك وليست خالتك من تكون ؟ ')
name = string.gsub(name,'الابره','ما هو الشيئ الذي كلما خطا خطوه فقد شيئا من ذيله ؟ ')
name = string.gsub(name,'الساعه','ما هو الشيئ الذي يقول الصدق ولكنه اذا جاع كذب ؟')
name = string.gsub(name,'22','كم مره ينطبق عقربا الساعه على بعضهما فـيٰ اليوم الواحد ')
...
name = string.gsub(name,'الثلج','انا ابن الماء فان تركوني فـيٰ الماء مت فمن انا ؟')
name = string.gsub(name,'الاسفنج','كلي ثقوب ومع ذالك احفض الماء فمن اكون ؟')
name = string.gsub(name,'الصوت','اسير بلا رجلين ولا ادخل الا بالاذنين فمن انا ؟')
name = string.gsub(name,'بلم','حامل ومحمول نصف ناشف ونصف مبلول فمن اكون ؟ ')
mustafaTEAM = '✘ ∫ اول وآحـډ يحلها يٍٰࢪبح ⏎ '..name
Dev_mfm(msg.chat_id_, msg.id_, 1,mustafaTEAM, 1, 'md')
return false
end end
if text == Devmfm:get(mustafa..'mfm:GameNum'..msg.chat_id_) and not Devmfm:get(mustafa..'mfm:Games:Ids'..msg.chat_id_) then
if not Devmfm:get(mustafa..'mfm:Games:Ids'..msg.chat_id_) then 
mustafaTEAM = '✘ ∫ مبّــروُڪ لقډ ٍࢪبحـت فـيٰ آللعبّــهہ 🎮 \n✘ ∫ آٍࢪسۧل ⏎ حزوره للعـب مـٍࢪهہ اۣخࢪى 🕹'
Dev_mfm(msg.chat_id_, msg.id_, 1,mustafaTEAM, 1, 'md')
Devmfm:incrby(mustafa..'mfm:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
end
Devmfm:set(mustafa..'mfm:Games:Ids'..msg.chat_id_,true)
...
if not Devmfm:get(mustafa..'mfm:Lock:Games'..msg.chat_id_) then
Devmfm2 = {'قرد','دجاجه','بطريق','ضفدع','بومه','نحله','ديك','جمل','بقره','دولفـيٰن','تمساح','قرش','نمر','اخطبوط','سمكه','خفاش','اسد','فأر','ذئب','فراشه','عقرب','زرافه','قنفذ','تفاحه','باذنجان'}
name = Devmfm2[math.random(#Devmfm2)]
...
name = string.gsub(name,'دولفـيٰن','🐬')
...
if not Devmfm:get(mustafa..'mfm:Games:Ids'..msg.chat_id_) then 
mustafaTEAM = '✘ ∫ مبّــروُڪ لقډ ٍࢪبحـت فـيٰ آللعبّــهہ 🎮 \n✘ ∫ آٍࢪسۧل ⏎ المعاني للعـب مـٍࢪهہ اۣخࢪى 🕹'
Dev_mfm(msg.chat_id_, msg.id_, 1,mustafaTEAM, 1, 'md')
Devmfm:incrby(mustafa..'mfm:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
end
Devmfm:set(mustafa..'mfm:Games:Ids'..msg.chat_id_,true)
...
if not Devmfm:get(mustafa..'mfm:Games:Ids'..msg.chat_id_) then 
mustafaTEAM = '✘ ∫ مبّــروُڪ لقډ ٍࢪبحـت فـيٰ آللعبّــهہ 🎮 \n✘ ∫ آٍࢪسۧل ⏎ العكس للعـب مـٍࢪهہ اۣخࢪى 🕹'
Dev_mfm(msg.chat_id_, msg.id_, 1,mustafaTEAM, 1, 'md')
Devmfm:incrby(mustafa..'mfm:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
end
Devmfm:set(mustafa..'mfm:Games:Ids'..msg.chat_id_,true)
...
if not Devmfm:get(mustafa..'mfm:Lock:Games'..msg.chat_id_) then
Devmfm2 = {
'جوز','ضراطه','الحبل','الحافـيٰ','شقره','بيدك','سلايه','النخله','الخيل','حداد','المبلل','يركص','قرد','العنب','العمه','الخبز','بالحصاد','شهر','شكه','يكحله',
};
name = Devmfm2[math.random(#Devmfm2)]
...
name = string.gsub(name,'بيدك','اكل ___ محد يفـيٰدك')
name = string.gsub(name,'الحافـيٰ','تجدي من ___ نعال')
...
mustafaTEAM = '✘ ∫ مبّــروُڪ لقډ ٍࢪبحـت فـيٰ آللعبّــهہ 🎮 \n✘ ∫ آٍࢪسۧل ⏎ امثله للعـب مـٍࢪهہ اۣخࢪى 🕹'
Dev_mfm(msg.chat_id_, msg.id_, 1,mustafaTEAM, 1, 'md')
end
Devmfm:set(mustafa..'mfm:Games:Ids'..msg.chat_id_,true)
end  
...
mustafaTEAM = '✘ ∫ مبّــروُڪ لقډ ٍࢪبحـت فـيٰ آللعبّــهہ 🎮 \n✘ ∫ آٍࢪسۧل ⏎ رياضيات للعـب مـٍࢪهہ اۣخࢪى 🕹'
Dev_mfm(msg.chat_id_, msg.id_, 1,mustafaTEAM, 1, 'md')
end
Devmfm:set(mustafa..'mfm:Games:Ids'..msg.chat_id_,true)
end  
...
mustafaTEAM = '✘ ∫ مبّــروُڪ لقډ ٍࢪبحـت فـيٰ آللعبّــهہ 🎮 \n✘ ∫ آٍࢪسۧل ⏎ انكليزيه للعـب مـٍࢪهہ اۣخࢪى 🕹'
Dev_mfm(msg.chat_id_, msg.id_, 1,mustafaTEAM, 1, 'md')
end
Devmfm:set(mustafa..'mfm:Games:Ids'..msg.chat_id_,true)
end  
...
if not Devmfm:get(mustafa..'mfm:Lock:Games'..msg.chat_id_) then
Devmfm2 = {'النيل','14','الفم','11','30','بوتين','ستيف جوبر','باريس','10','النمل','حرف الواو','الشعر','سحاب','الاسم','ذهب','حرف الام','العزائم','انسات','المنجنيق','اسيا','6','الاسد','مهر','الدولفـيٰن','اوروبا','الزئبق','لندن','الانسان','اسكوبار','خديجه',}
name = Devmfm2[math.random(#Devmfm2)]
Devmfm:set(mustafa..'mfm:GameNum8'..msg.chat_id_,name)
Devmfm:del(mustafa..'mfm:Games:Ids'..msg.chat_id_)
name = string.gsub(name,'النيل','✘ ∫ ماهو اطول نهر فـيٰ العالم ؟\n1- النيل\n2- الفرات\n3- نهر الكونغو')
...
name = string.gsub(name,'بوتين','✘ ∫ من هوه اغنى رئيس فـيٰ العالم ؟\n1- ترامب\n2- اوباما\n3- بوتين')
name = string.gsub(name,'ستيف جوبر','✘ ∫ من هوه مؤسس شركه ابل العالميه  ؟\n1- لاري بايج\n2- بيل جيتس\n3- ستيف جوبر')
name = string.gsub(name,'باريس','ماهي عاصمه فرنسا ؟\n1- باريس\n2- لوين\n3- موسكو')
name = string.gsub(name,'10','✘ ∫ ماعدد دول العربيه التي توجد فـيٰ افريقيا ؟\n1- 10\n2- 17\n3- 9')
...
name = string.gsub(name,'حرف الام','✘ ∫ فـيٰ الليل ثلاثة لكنه فـيٰ النهار واحده فما هو ؟\n1- حرف الباء\n2- حرف الام\n3- حرف الراء')
name = string.gsub(name,'العزائم','✘ ∫ على قدر اصل العزم تأتي ؟\n1- العزائم\n2- المكارم\n3- المبائب')
name = string.gsub(name,'انسات','✘ ∫ ماهي جمع كلمه انسه ؟\n1- سيدات\n2- انسات\n3- قوانص')
name = string.gsub(name,'المنجنيق','✘ ∫ اله اتسعلمت قديما فـيٰ الحروب ؟\n1- الصاروخ\n2- المسدس\n3- المنجنيق')
name = string.gsub(name,'اسيا','✘ ∫ تقع لبنان فـيٰ قاره ؟\n1- افريقيا\n2- اسيا\n3- امركيا الشماليه')
...
name = string.gsub(name,'الدولفـيٰن','✘ ∫ ما الحيوان الذي ينام واحدى عينه مفتوحه ؟\n1- القرش\n2- الدولفـيٰن\n3- الثعلب\n')
name = string.gsub(name,'اوروبا','✘ ∫ ماهي القاره التي تلقب بالقاره العجوز ؟\n1- اوروبا\n2- امريكا الشماليه\n3- افريقيا')
name = string.gsub(name,'الزئبق','✘ ∫ ما اسم المعدن الموجود فـيٰي الحاله السائله ؟\n1- النحاس\n2- الحديد\n3- الزئبق')
name = string.gsub(name,'لندن','✘ ∫ ماهي عاصمه انجلترا ؟\n1- لندن\n2- لفرسول\n3- تركيا')
name = string.gsub(name,'الانسان','✘ ∫ ماهو الشئ الذي برأسه سبع فتحات ؟\n1- الهاتف\n2- التلفاز\n3- الانسان')
name = string.gsub(name,'اسكوبار','✘ ∫ ماهي عاصمه اليابان ؟\n1- بانكول\n2- نيو دلهي\n3- اسكوبار')
name = string.gsub(name,'خديجه','✘ ∫ من هي زوجه الرسول الاكبر منه سنآ ؟\n1- حفضه\n2- زينب\n3- خديجه')
mustafaTEAM = name..'\n✘ ∫ آٍࢪسۧل الجواب الصحيح فقط'
Dev_mfm(msg.chat_id_, msg.id_, 1,mustafaTEAM, 1, 'md')
return false
end end
...
mustafaTEAM = '✘ ∫ مبّــروُڪ لقډ ٍࢪبحـت فـيٰ آللعبّــهہ 🎮 \n✘ ∫ آٍࢪسۧل ⏎ الاسئله للعـب مـٍࢪهہ اۣخࢪى 🕹'
Dev_mfm(msg.chat_id_, msg.id_, 1,mustafaTEAM, 1, 'md')
end
Devmfm:set(mustafa..'mfm:Games:Ids'..msg.chat_id_,true)
end  
...
Dev_mfm(msg.chat_id_, msg.id_, 1,"✘ ∫ عــــــــذرآ لا يمكنك تخمين عدد اكبر من الـ20 خمن رقم ما بين الـ1 والـ20", 1, 'md')
return false  end 
...
Dev_mfm(msg.chat_id_, msg.id_, 1,'✘ ∫ لقد خمنت الرقم الخطا وتبقى لديك '..SetNum..' آٍࢪسۧل رقم تخمنه مره اخرى للفوز', 1, 'md')
end
end
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1,'✘ ∫ آهـلُِآ بك عٍزْيـــــــّــزْي فـيٰ لعبة التخمين ⏎ ⥡\n ┉┉┉┉ EB ┉┉┉┉\n✘ ∫ سيتم تخمين عدد ما بين الـ1 والـ20 اذا تعتقد انك تسۧتطيٰع الفوز جرب واللعب الان .\n✘ ∫ ملاحظه لديك ثلاث محاولات فقط فكر قبل ارسال تخمينك !', 1, 'md')
...
local Text = "✘ ∫ تــمِ ادخال المعرف ⏎ ["..text.."]\n✘ ∫ وتم اكتمال العدد الكلي هل انت مستعد ؟"
keyboard = {} 
keyboard.inline_keyboard = {{{text="نعم",callback_data="/YesRolet"},{text="لا",callback_data="/NoRolet"}},{{text="اللاعبين",callback_data="/ListRolet"}}} 
Msg_id = msg.id_/2097152/0.5
return https.request("https://api.telegram.org/bot"..TokenBot..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..Msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end 
local Text = "✘ ∫ تــمِ ادخال المعرف ⏎ ["..text.."] وتبقى ⏎ "..CountUser.." لاعبين ليكتمل العدد آٍࢪسۧل المعرف الاخر"
keyboard = {} 
...
if not Devmfm:get(mustafa..'mfm:Lock:Games'..msg.chat_id_) then
local mustafaTEAM = {  
'آخر مرة زرت مدينة الملاهي؟','آخر مرة أكلت أكلتك المفضّلة؟','الوضع الحالي؟\n‏1. سهران\n‏2. ضايج\n‏3. أتأمل','آخر شيء ضاع منك؟','كلمة أخيرة لشاغل البال؟','طريقتك المعتادة فـيٰ التخلّص من الطاقة السلبية؟','شهر من أشهر العام له ذكرى جميلة معك؟','كلمة غريبة من لهجتك ومعناها؟🤓','‏- شيء سمعته عالق فـيٰ ذهنك هاليومين؟','متى تكره الشخص الذي أمامك حتى لو كنت مِن أشد معجبينه؟','‏- أبرز صفة حسنة فـيٰ صديقك المقرب؟','هل تشعر أن هنـآلك مَن يُحبك؟','اذا اكتشفت أن أعز أصدقائك يضمر لك السوء، موقفك الصريح؟','أجمل شيء حصل معك خلال هاليوم؟','صِف شعورك وأنت تُحب شخص يُحب غيرك؟👀💔','كلمة لشخص غالي اشتقت إليه؟💕','آخر خبر سعيد، متى وصلك؟','أنا آسف على ....؟','أوصف نفسك بكلمة؟','صريح، مشتاق؟','‏- صريح، هل سبق وخذلت أحدهم ولو عن غير قصد؟','‏- ماذا ستختار من الكلمات لتعبر لنا عن حياتك التي عشتها الى الآن؟💭','‏- فنان/ة تود لو يدعوكَ على مائدة عشاء؟😁❤','‏- تخيّل شيء قد يحدث فـيٰ المستقبل؟','‏- للشباب | آخر مرة وصلك غزل من فتاة؟🌚','شخص أو صاحب عوضك ونساك مُر الحياة ما اسمه ؟','| اذا شفت حد واعجبك وعندك الجرأه انك تروح وتتعرف عليه ، مقدمة الحديث شو راح تكون ؟.','كم مره تسبح باليوم','نسبة النعاس عندك حاليًا؟','لو فقط مسموح شخص واحد تتابعه فالسناب مين بيكون ؟','يهمك ملابسك تكون ماركة ؟','وش الشيء الي تطلع حرتك فـيٰه و زعلت ؟','عندك أخوان او خوات من الرضاعة؟','عندك معجبين ولا محد درا عنك؟',
'أطول مدة قضيتها بعيد عن أهلك ؟','لو يجي عيد ميلادك تتوقع يجيك هدية؟','يبان عليك الحزن من " صوتك - ملامحك','وين تشوف نفسك بعد سنتين؟','وش يقولون لك لما تغني ؟','عندك حس فكاهي ولا نفسية؟','كيف تتصرف مع الشخص الفضولي ؟','كيف هي أحوال قلبك؟','حاجة تشوف نفسك مبدع فـيٰها ؟','متى حبيت؟','شيء كل م تذكرته تبتسم ...','العلاقه السريه دايماً تكون حلوه؟','صوت مغني م تحبه','لو يجي عيد ميلادك تتوقع يجيك هدية؟','اذا احد سألك عن شيء م تعرفه تقول م اعرف ولا تتفلسف ؟','مع او ضد : النوم افضل حل لـ مشاكل الحياة؟','مساحة فارغة (..............) اكتب اي شيء تبين','اغرب اسم مر عليك ؟','عمرك كلمت فويس احد غير جنسك؟','اذا غلطت وعرفت انك غلطان تحب تعترف ولا تجحد؟','لو عندك فلوس وش السيارة اللي بتشتريها؟','وش اغبى شيء سويته ؟','شيء من صغرك ماتغير فـيٰك؟','وش نوع الأفلام اللي تحب تتابعه؟','وش نوع الأفلام اللي تحب تتابعه؟','تجامل احد على حساب مصلحتك ؟','تتقبل النصيحة من اي شخص؟','كلمه ماسكه معك الفترة هذي ؟','متى لازم تقول لا ؟','اكثر شيء تحس انه مات ف مجتمعنا؟','تؤمن ان فـيٰ "حُب من أول نظرة" ولا لا ؟.','تؤمن ان فـيٰ "حُب من أول نظرة" ولا لا ؟.','هل تعتقد أن هنـآلك من يراقبك بشغف؟','اشياء اذا سويتها لشخص تدل على انك تحبه كثير ؟','اشياء صعب تتقبلها بسرعه ؟','اقتباس لطيف؟','أكثر جملة أثرت بك فـيٰ حياتك؟','عندك فوبيا من شيء ؟.',
'اكثر لونين تحبهم مع بعض؟','أجمل بيت شعر سمعته ...','سبق وراودك شعور أنك لم تعد تعرف نفسك؟','تتوقع فـيٰه احد حاقد عليك ويكرهك ؟','أجمل سنة ميلادية مرت عليك ؟','لو فزعت/ي لصديق/ه وقالك مالك دخل وش بتسوي/ين؟','وش تحس انك تحتاج الفترة هاذي ؟','يومك ضاع على؟','@منشن .. شخص تخاف منه اذا عصب ...','فـيٰلم عالق فـيٰ ذهنك لا تنساه مِن روعته؟','تختار أن تكون غبي أو قبيح؟','الفلوس او الحب ؟','أجمل بلد فـيٰ قارة آسيا بنظرك؟','ما الذي يشغل بالك فـيٰ الفترة الحالية؟','احقر الناس هو من ...','وين نلقى السعاده برايك؟','اشياء تفتخر انك م سويتها ؟','تزعلك الدنيا ويرضيك ؟','وش الحب بنظرك؟','افضل هديه ممكن تناسبك؟','كم فـيٰ حسابك البنكي ؟','كلمة لشخص أسعدك رغم حزنك فـيٰ يومٍ من الأيام ؟','عمرك انتقمت من أحد ؟!','ما السيء فـيٰ هذه الحياة ؟','غنية عندك معاها ذكريات🎵🎻','/','أفضل صفة تحبه بنفسك؟','اكثر وقت تحب تنام فـيٰه ...','أطول مدة نمت فـيٰها كم ساعة؟','أصعب قرار ممكن تتخذه ؟','أفضل صفة تحبه بنفسك؟','اكثر وقت تحب تنام فـيٰه ...','أنت محبوب بين الناس؟ ولاكريه؟','إحساسك فـيٰ هاللحظة؟','اخر شيء اكلته ؟','تشوف الغيره انانيه او حب؟','اذكر موقف ماتنساه بعمرك؟','اكثر مشاكلك بسبب ؟','اول ماتصحى من النوم مين تكلمه؟','آخر مرة ضحكت من كل قلبك؟','لو الجنسية حسب ملامحك وش بتكون جنسيتك؟','اكثر شيء يرفع ضغطك','اذكر موقف ماتنساه بعمرك؟','لو قالوا لك  تناول صنف واحد فقط من الطعام لمدة شهر .',
'كيف تشوف الجيل ذا؟','ردة فعلك لو مزح معك شخص م تعرفه ؟','احقر الناس هو من ...','تحب ابوك ولا امك','آخر فـيٰلم مسلسل والتقييم🎥؟','أقبح القبحين فـيٰ العلاقة: الغدر أو الإهمال🤷🏼؟','كلمة لأقرب شخص لقلبك🤍؟','حط@منشن لشخص وقوله "حركتك مالها داعي"😼!','اذا جاك خبر مفرح اول وآحـډ تعلمه فـيٰه مين💃🏽؟','طبع يمكن يخليك تكره شخص حتى لو كنت تُحبه🙅🏻‍♀️؟','افضل ايام الاسبوع عندك🔖؟','يقولون ان الحياة دروس ، ماهو أقوى درس تعلمته من الحياة🏙؟','تاريخ لن تنساه📅؟','تحب الصيف والا الشتاء❄️☀️؟','شخص تحب تستفزه😈؟','شنو ينادونك وانت صغير (عيارتك)👼🏻؟','عقل يفهمك/ج ولا قلب يحبك/ج❤️؟','اول سفره لك وين رح تكون✈️؟','كم عدد اللي معطيهم بلوك👹؟','نوعية من الأشخاص تتجنبهم فـيٰ حياتك❌؟','شاركنا صورة او فـيٰديو من تصويرك؟📸','كم من عشره تعطي حظك📩؟','اكثر برنامج تواصل اجتماعي تحبه😎؟','من اي دوله انت🌍؟','اكثر دوله ودك تسافر لها🏞؟','مقولة "نكبر وننسى" هل تؤمن بصحتها🧓🏼؟','تعتقد فـيٰه أحد يراقبك👩🏼‍💻؟','لو بيدك تغير الزمن ، تقدمه ولا ترجعه🕰؟','مشروبك المفضل🍹؟','‏قم بلصق آخر اقتباس نسخته؟💭','كم وزنك/ج طولك/ج؟🌚','كم كان عمرك/ج قبل ٨ سنين😈؟','دوله ندمت انك سافرت لها😁؟','لو قالو لك ٣ أمنيات راح تتحقق عالسريع شنو تكون🧞‍♀️؟','‏- نسبة احتياجك للعزلة من 10📊؟','شخص تحبه حظرك بدون سبب واضح، ردة فعلك🧐؟','مبدأ فـيٰ الحياة تعتمد عليه دائما🕯؟'
, }  
Dev_mfm(msg.chat_id_, msg.id_, 1, ''..mustafaTEAM[math.random(#mustafaTEAM)]..'' , 1, 'md')  
return false
end
end
if text == 'الالعاب' and ChCheck(msg) or text == 'العاب' and ChCheck(msg) or text == 'آللعبّــهہ 🎮' and ChCheck(msg) then
if not Devmfm:get(mustafa..'mfm:Lock:Games'..msg.chat_id_) then
Dev_mfm(msg.chat_id_, msg.id_, 1,[[*
✘ ∫ قآإئمـَـهہ العاب آلَمـجـ̨مـۈعة ⏎ ⥡
┉┉┉┉ EB ┉┉┉┉
✘ ∫ لعبة التخمين ⏎ خمن
✘ ∫ لعبة الامثله ⏎ امثله
✘ ∫ لعبة العكس ⏎ العكس
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ عــــــــذرآ الالعاب مـعـطله فـيٰ آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1,'✘ ∫ تــمِ بيع '..(Devmfm:get(mustafa..'mfm:GamesNumber'..msg.chat_id_..msg.sender_user_id_))..' من نقآطڪ\n✘ ∫ كل نقطه تساوي 50 رساله', 'md')
Devmfm:del(mustafa..'mfm:GamesNumber'..msg.chat_id_..msg.sender_user_id_)
end
end
if text == 'رفع المشرفـيٰن' and ChCheck(msg) or text == 'رفع الادمنيه' and ChCheck(msg) then  
...
if num == 0 then
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ لا يوجد ادمنيه ليتم ٍࢪفعـهہم\n✘ ∫ تــمِ رفع منشئ آلَمـجـ̨مـۈعة", 1, 'md')
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ رفع '..num..' من الادمنيه \n✘ ∫ تــمِ رفع منشئ آلَمـجـ̨مـۈعة', 1, 'md')
end
end,nil) 
end
if text == 'غادر' and SudoBot(msg) then
if Devmfm:get(mustafa.."mfm:Left:Bot"..mustafa) and not SecondSudo(msg) then
Dev_mfm(msg.chat_id_,msg.id_, 1, "✘ ∫ المغادره مـعـطله من قبل المطور الاساسي", 1, 'md')
return false  
end
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ مغادرة آلَمـجـ̨مـۈعة \n✘ ∫ تــمِ حذف جميع بياناتها ', 1, 'md')
...
send(msg.chat_id_, msg.id_, '✘ ∫ آٍࢪسۧل لي معرف قناة الاشتراك الان')
end
return false  
end
...
Devmfm:setex(mustafa..'Devmfm4'..msg.sender_user_id_,360,true)
send(msg.chat_id_, msg.id_,"✘ ∫ لاتوجد قناة لتفعيل الاشتراك\n✘ ∫ آٍࢪسۧل لي معرف قناة الاشتراك الان")
end
end
return false  
end
...
Devmfm:del(mustafa..'Devmfm2') Devmfm:del(mustafa..'Devmfm3')
Dev_mfm(msg.chat_id_, msg.id_, 1,"✘ ∫ تــمِ حذف قناة الاشتراك الاجباري", 1, 'md') 
end
end
if SecondSudo(msg) then
...
send(msg.chat_id_, msg.id_, "✘ ∫ لاتوجد قناة فـيٰ الاشتراك الاجباري")
end
return false  
end end
if SudoBot(msg) then
...
send(msg.chat_id_, msg.id_,"✘ ∫ الاذاعه مـعـطله من قبل المطور الاساسي")
return false
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ اذاعة رسالتك بالتوجيه \n✘ ∫ ‏فـيٰ ⏎ ❨ '..#GpList..' ❩ مجموعه \n✘ ∫ والى ⏎ ❨ '..#PvList..' ❩ م��ترك \n ✓', 1, 'md')
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ عــــــــذرآ هذه الخاصيه مـعـطله ', 1, 'md')
return false
end
...
local user_msgs = Devmfm:get(mustafa..'mfm:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ عدد ٍࢪسۧآئلڪ هنـآ ⏎ *❨ "..user_msgs.." ❩*", 1, 'md')
end
...
if text == "معرفـيٰ" and ChCheck(msg) then
...
if text == "مبرمج السورس" then  Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ [@F16_ibra]', 1, 'md') end
if text == "مطور السورس" then  Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ @MFMVIP', 1, 'md') end
...
if text == "رابط حذف" or text == "رابط الحذف" or text == "اريد رابط الحذف" or  text == "شمرلي رابط الحذف" or text == "اريد رابط حذف" then local inline = {{{text="اضغط هنـآ",url="https://my.telegram.org/auth"}}} SendInline(msg.chat_id_,'✘ ∫ اضغط للحصول على الرابط',nil,inline) return false end
...
local mustafaTEAM = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_mfm(msg.chat_id_, msg.id_, 1,mustafaTEAM, 1, 'md') 
local mustafaTEAM = {"لكك جرجف احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","هشش فاشل لتضل تمسلت لا اخربط تضاريس وجهك جنه ابط عبده، 😖👌🏿","دمشي لك ينبوع الفشل مو زين ملفـيٰك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪","حبيبي راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪"} 
...
local mustafaTEAM = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_mfm(msg.chat_id_, msg.id_, 1,mustafaTEAM, 1, 'md') 
local mustafaTEAM = {"مواححح افـيٰش عافـيٰههه😍🔥💗","امممووااهحح شهلعسل🥺🍯💘","مواححح،ءوفف اذوب🤤💗"} 
Dev_mfm(msg.chat_id_, result.id_, 1,''..mustafaTEAM[math.random(#mustafaTEAM)]..'', 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ لاتسۧتطيٰع تنزيل المطور الاساسي", 1, 'md')
return false 
end
...
ReplyStatus(msg,result.id_,"Reply","✘ ∫ تــمِ تنزيٰلـهہ من ⏎ ⥡\n~ ( "..secondsudo..''..sudobot..''..managerall..''..adminall..''..vpall..''..basicconstructor..''..constructor..''..manager..''..admins..''..vipmem..''..cleaner.." ) ~")  
else 
...
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ فـيٰ قآإئمـَـهہ آلمـطوٍࢪين اݪثـأنوٰيين*")  
end 
...
ReplyStatus(msg,result.id_,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ فـيٰ قآإئمـَـهہ آلمـطوٍࢪين اݪثـأنوٰيين*")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
...
ReplyStatus(msg,user,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ فـيٰ قآإئمـَـهہ آلمـطوٍࢪين اݪثـأنوٰيين*")  
end
--     Rem SecondSudo     --
if text ==('حذف مطور ثانوي') or text ==('تنزيل مطور ثانوي') and ChCheck(msg) then
function prom_reply(extra, result, success)
Devmfm:srem(mustafa..'mfm:SecondSudo:',result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ تنزيٰلـهہ من قآإئمـَـهہ آلمـطوٍࢪين اݪثـأنوٰيين*")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
...
if result.id_ then
Devmfm:srem(mustafa..'mfm:SecondSudo:',result.id_)
ReplyStatus(msg,result.id_,"Reply","*✘ ∫ تــمِ تنزيٰلـهہ من قآإئمـَـهہ المطورين اݪثـأنوٰيين*")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","*✘ ∫ تــمِ تنزيٰلـهہ من قآإئمـَـهہ آلمـطوٍࢪين اݪثـأنوٰيين*")  
end end
--       Set SudoBot      --
if SecondSudo(msg) then
...
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ فـيٰ قآإئمـَـهہ آلمـطوٍࢪين*")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),sudo_reply)
...
ReplyStatus(msg,result.id_,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ فـيٰ قآإئمـَـهہ آلمـطوٍࢪين*")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ فـيٰ قآإئمـَـهہ آلمـطوٍࢪين*")  
end
--       Rem SudoBot      --
if text ==('حذف مطور') or text ==('تنزيل مطور') and ChCheck(msg) then
function prom_reply(extra, result, success)
Devmfm:srem(mustafa..'mfm:SudoBot:',result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ تنزيٰلـهہ من قآإئمـَـهہ آلمـطوٍࢪين*")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
Devmfm:srem(mustafa..'mfm:SudoBot:',result.id_)
ReplyStatus(msg,result.id_,"Reply","*✘ ∫ تــمِ تنزيٰلـهہ من قآإئمـَـهہ آلمـطوٍࢪين*")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","*✘ ∫ تــمِ تنزيٰلـهہ من قآإئمـَـهہ آلمـطوٍࢪين*")  
end end
--      Set ManagerAll    --
if SudoBot(msg) then
...
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ فـيٰ قآإئمـَـهہ آلمـډٍࢪآ۽ آلعـآمين*")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
...
ReplyStatus(msg,result.id_,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ فـيٰ قآإئمـَـهہ آلمـډٍࢪآ۽ آلعـآمين*")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ فـيٰ قآإئمـَـهہ آلمـډٍࢪآ۽ آلعـآمين*")  
end
--      Rem ManagerAll    --
if text ==('تنزيل مدير عام') and ChCheck(msg) then
function prom_reply(extra, result, success)
Devmfm:srem(mustafa..'mfm:ManagerAll:',result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ تنزيٰلـهہ من قآإئمـَـهہ آلمـډٍࢪآ۽ آلعـآمين*")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
Devmfm:srem(mustafa..'mfm:ManagerAll:',result.id_)
ReplyStatus(msg,result.id_,"Reply","*✘ ∫ تــمِ تنزيٰلـهہ من قآإئمـَـهہ آلمـډٍࢪآ۽ آلعـآمين*")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","*✘ ∫ تــمِ تنزيٰلـهہ من قآإئمـَـهہ آلمـډٍࢪآ۽ آلعـآمين*")  
end end
--      Set adminall      --
...
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ فـيٰ قآإئمـَـهہ آلآډمـنيهہ آلعـآمين*")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),raf_reply)
...
ReplyStatus(msg,result.id_,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ فـيٰ قآإئمـَـهہ آلآډمـنيهہ آلعـآمين*")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ فـيٰ قآإئمـَـهہ آلآډمـنيهہ آلعـآمين*")  
end
--      Rem adminall      --
if text ==('تنزيل ادمن عام') and ChCheck(msg) then
function prom_reply(extra, result, success)
Devmfm:srem(mustafa..'mfm:AdminAll:',result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ تنزيٰلـهہ من قآإئمـَـهہ آلآډمـنيهہ آلعـآمين*")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
Devmfm:srem(mustafa..'mfm:AdminAll:',result.id_)
ReplyStatus(msg,result.id_,"Reply","*✘ ∫ تــمِ تنزيٰلـهہ من قآإئمـَـهہ آلآډمـنيهہ آلعـآمين*")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","*✘ ∫ تــمِ تنزيٰلـهہ من قآإئمـَـهہ آلآډمـنيهہ آلعـآمين*")  
end end
--       Set Vipall       --
...
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ فـيٰ قآإئمـَـهہ آلمـميٰزين آلعـآم*")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),raf_reply)
...
ReplyStatus(msg,result.id_,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ فـيٰ قآإئمـَـهہ آلمـميٰزين آلعـآم*")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ فـيٰ قآإئمـَـهہ آلمـميٰزين آلعـآم*")  
end
--       Rem Vipall       --
if text ==('تنزيل مميز عام') and ChCheck(msg) then
function prom_reply(extra, result, success)
Devmfm:srem(mustafa..'mfm:VipAll:',result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ تنزيٰلـهہ من قآإئمـَـهہ آلمـميٰزين آلعـآم*")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
Devmfm:srem(mustafa..'mfm:VipAll:',result.id_)
ReplyStatus(msg,result.id_,"Reply","*✘ ∫ تــمِ تنزيٰلـهہ من قآإئمـَـهہ آلمـميٰزين آلعـآم*")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","*✘ ∫ تــمِ تنزيٰلـهہ من قآإئمـَـهہ آلمـميٰزين آلعـآم*")  
end end
...
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ مـنشـئ آسۧآسۧي*")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),raf_reply)
...
ReplyStatus(msg,result.id_,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ مـنشـئ آسۧآسۧي*")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ مـنشـئ آسۧآسۧي*")  
end
--  Rem BasicConstructor  --
if text ==('تنزيل منشئ اساسي') and ChCheck(msg) then
function prom_reply(extra, result, success)
Devmfm:srem(mustafa..'mfm:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ تنزيٰلـهہ مـنشـئ آسۧآسۧي*")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
Devmfm:srem(mustafa..'mfm:BasicConstructor:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","*✘ ∫ تــمِ تنزيٰلـهہ مـنشـئ آسۧآسۧي*")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ تنزيٰلـهہ منشئ اساسي")  
end end
if text ==('رفع منشئ اساسي') and not mfmConstructor(msg) then
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ هذا الامر لمنشئ آلَمـجـ̨مـۈعة والمطورين فقط', 1, 'md')
end
--    Set  Constructor    --
...
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ فـيٰ قآإئمـَـهہ آلمـنشـئيٰن*")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),raf_reply)
...
ReplyStatus(msg,result.id_,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ فـيٰ قآإئمـَـهہ آلمـنشـئيٰن*")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ فـيٰ قآإئمـَـهہ آلمـنشـئيٰن*")  
end
--    Rem  Constructor    --
if text ==('تنزيل منشئ') and ChCheck(msg) then
function prom_reply(extra, result, success)
Devmfm:srem(mustafa..'mfm:Constructor:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ تنزيٰلـهہ من قآإئمـَـهہ آلمـنشـئيٰن*")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
Devmfm:srem(mustafa..'mfm:Constructor:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","*✘ ∫ تــمِ تنزيٰلـهہ من قآإئمـَـهہ آلمـنشـئيٰن*")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","*✘ ∫ تــمِ تنزيٰلـهہ من قآإئمـَـهہ آلمـنشـئيٰن*")  
end 
end
--      Set Manager       --
if Constructor(msg) then
...
function prom_reply(extra, result, success)
Devmfm:sadd(mustafa..'mfm:Managers:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ فـيٰ قآإئمـَـهہ آلمـډٍࢪآ۽*")  
end  
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
Devmfm:sadd(mustafa..'mfm:Managers:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ فـيٰ قآإئمـَـهہ آلمـډٍࢪآ۽*")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ فـيٰ قآإئمـَـهہ آلمـډٍࢪآ۽*")  
end
--       Rem Manager      --
if text ==('تنزيل مدير') and ChCheck(msg) then
function prom_reply(extra, result, success)
Devmfm:srem(mustafa..'mfm:Managers:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ تنزيٰلـهہ من قآإئمـَـهہ آلمـډٍࢪآ۽*")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
Devmfm:srem(mustafa..'mfm:Managers:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","*✘ ∫ تــمِ تنزيٰلـهہ من قآإئمـَـهہ آلمـډٍࢪآ۽*")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","*✘ ∫ تــمِ تنزيٰلـهہ من قآإئمـَـهہ آلمـډٍࢪآ۽*")  
end 
--       Set Cleaner      --
if text ==('رفع منظف') and ChCheck(msg) then
function prom_reply(extra, result, success)
Devmfm:sadd(mustafa..'mfm:Cleaner:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ فـيٰ قآإئمـَـهہ المنظفـيٰن*")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
ReplyStatus(msg,result.id_,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ فـيٰ قآإئمـَـهہ المنظفـيٰن*")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ فـيٰ قآإئمـَـهہ المنظفـيٰن*")  
end
--       Rem Cleaner      --
if text ==('تنزيل منظف') and ChCheck(msg) then
function prom_reply(extra, result, success)
Devmfm:srem(mustafa..'mfm:Cleaner:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ تنزيٰلـهہ من قآإئمـَـهہ المنظفـيٰن*")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
Devmfm:srem(mustafa..'mfm:Cleaner:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","*✘ ∫ تــمِ تنزيٰلـهہ من قآإئمـَـهہ المنظفـيٰن*")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","*✘ ∫ تــمِ تنزيٰلـهہ من قآإئمـَـهہ المنظفـيٰن*")  
end end
--       Set admin        --
if Manager(msg) then
...
Dev_mfm(msg.chat_id_, msg.id_, 1,'✘ ∫ لاتسۧتطيٰع رفع احد وذالك بسبب تعطيل الرفع من قبل آلمـنشـئيٰن', 1, 'md')
return false
end
Devmfm:sadd(mustafa..'mfm:Admins:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ فـيٰ قآإئمـَـهہ آلآډمـنيهہ*")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
Devmfm:sadd(mustafa..'mfm:Admins:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ فـيٰ قآإئمـَـهہ آلآډمـنيهہ*")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ فـيٰ قآإئمـَـهہ آلآډمـنيهہ*")  
end
--        Rem admin       --
if text ==('تنزيل ادمن') and ChCheck(msg) then
function prom_reply(extra, result, success)
Devmfm:srem(mustafa..'mfm:Admins:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ تنزيٰلـهہ من قآإئمـَـهہ آلآډمـنيهہ*")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
Devmfm:srem(mustafa..'mfm:Admins:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","*✘ ∫ تــمِ تنزيٰلـهہ من قآإئمـَـهہ آلآډمـنيهہ*")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","*✘ ∫ تــمِ تنزيٰلـهہ من قآإئمـَـهہ آلآډمـنيهہ*")  
end end
--       Set Vipmem       --
if Admin(msg) then
...
Devmfm:sadd(mustafa..'mfm:VipMem:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ فـيٰ قآإئمـَـهہ آلمـميٰزين*")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
Devmfm:sadd(mustafa..'mfm:VipMem:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ فـيٰ قآإئمـَـهہ آلمـميٰزين*")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ فـيٰ قآإئمـَـهہ آلمـميٰزين*")  
end
--       Rem Vipmem       --
if text ==('تنزيل مميز') and ChCheck(msg) then
function prom_reply(extra, result, success)
Devmfm:srem(mustafa..'mfm:VipMem:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ تنزيٰلـهہ من قآإئمـَـهہ آلمـميٰزين*")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
Devmfm:srem(mustafa..'mfm:VipMem:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","*✘ ∫ تــمِ تنزيٰلـهہ من قآإئمـَـهہ آلمـميٰزين*")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","*✘ ∫ تــمِ تنزيٰلـهہ من قآإئمـَـهہ آلمـميٰزين*")  
end end 
if BasicConstructor(msg) then
...
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ مـشـٍࢪف فـيٰ آلَمـجـ̨مـۈعة*")  
else
Dev_mfm(msg.chat_id_, msg.id_, 1,'✘ ∫ ليست لدي صلاحية اضافة مشرفـيٰن جدد يرجى التحقق من الصلاحيات', 1, 'md')
end
end
getMessage(msg.chat_id_, msg.reply_to_message_id_,promote_by_reply)
end
...
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ تنزيٰلـهہ من مشرفـيٰن آلَمـجـ̨مـۈعة*")  
else
Dev_mfm(msg.chat_id_, msg.id_, 1,'✘ ∫ ليست لدي صلاحية اضافة مشرفـيٰن جدد يرجى التحقق من الصلاحيات', 1, 'md')
end
end
...
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ مشرف فـيٰ جميع الصلاحيات*")  
else
Dev_mfm(msg.chat_id_, msg.id_, 1,'✘ ∫ ليست لدي صلاحية اضافة مشرفـيٰن جدد يرجى التحقق من الصلاحيات', 1, 'md')
end
end
...
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ اضافة ⏎ * "..mfm.."* كلقب له*")  
...
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ حذف الرساله مع رسالة الامر', 1, 'md')
end end end
if Constructor(msg) then
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ تفعيل رفع ⏎ الادمن • المميز', 1, 'md')
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ تعطيل رفع ⏎ الادمن • المميز', 1, 'md')
end
end
--          Kick          --
if Admin(msg) then
...
send(msg.chat_id_, msg.id_,'*✘ ∫ لقد تــمِ تعطيل الطرد والحظر من قبل المنشئين*')
return false
end
if RankChecking(result.sender_user_id_, result.chat_id_) then
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ لآ تسۧتطيٰع طٍࢪډ ⏎ *'..IdRank(result.sender_user_id_, msg.chat_id_), 1, 'md')
else
...
send(msg.chat_id_,msg.id_,"*✘ ∫ لا آسۧتطيٰع طٍࢪډ مشرفـيٰن آلَمـجـ̨مـۈعة*") 
return false  
end
ChatKick(result.chat_id_, result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ طٍࢪډهہ من آلَمـجـ̨مـۈعة*")  
end,nil)
end
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ لآ تسۧتطيٰع طٍࢪډ ⏎  * '..IdRank(result.id_, msg.chat_id_), 1, 'md')
else
...
ReplyStatus(msg,result.id_,"Reply","*✘ ∫ تــمِ طٍࢪډهہ من آلَمـجـ̨مـۈعة*")  
end,nil)
end
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
...
if not Constructor(msg) and Devmfm:get(mustafa.."mfm:Lock:KickBan"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,'*✘ ∫ لقد تــمِ تعطيل الطٍࢪډ والحظر من قبل المنشئين*')
return false
end
if RankChecking(user, msg.chat_id_) then
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ لآ تسۧتطيٰع طٍࢪډ ⏎ * '..IdRank(user, msg.chat_id_), 1, 'md')
else
...
ReplyStatus(msg,user,"Reply","*✘ ∫ تــمِ طٍࢪډهہ من آلَمـجـ̨مـۈعة*")  
end,nil)
end
end
end 
...
if RankChecking(result.sender_user_id_, result.chat_id_) then
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ لآ تسۧتطيٰع حظر ⏎ * '..IdRank(result.sender_user_id_, msg.chat_id_), 1, 'md')
else
tdcli_function({ID="ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=result.sender_user_id_,status_={ID="ChatMemberStatusKicked"},},function(arg,dp) 
if (dp and dp.code_ and dp.code_ == 400 and dp.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_,msg.id_,"*✘ ∫ ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !*") 
...
if dp and dp.code_ and dp.code_ == 400 and dp.message_ == "USER_ADMIN_INVALID" then 
send(msg.chat_id_,msg.id_,"*✘ ∫ لا آسۧتطيٰع حظر مشرفـيٰن آلَمـجـ̨مـۈعة*") 
return false  
end
ChatKick(result.chat_id_, result.sender_user_id_)
Devmfm:sadd(mustafa..'mfm:Ban:'..msg.chat_id_, result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ حظره من آلَمـجـ̨مـۈعة*") 
end,nil) 
end 
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
...
if result.id_ then
if RankChecking(result.id_, msg.chat_id_) then
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ لا تسۧتطيٰع حظر ⏎ * '..IdRank(result.id_, msg.chat_id_), 1, 'md')
else
tdcli_function({ID="ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=result.id_,status_={ID="ChatMemberStatusKicked"},},function(arg,dp) 
if (dp and dp.code_ and dp.code_ == 400 and dp.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_,msg.id_,"*✘ ∫ ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !*") 
...
ReplyStatus(msg,result.id_,"Reply","*✘ ∫ تــمِ حظره من آلَمـجـ̨مـۈعة*")  
end,nil) 
end
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
...
if RankChecking(user, msg.chat_id_) then
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ لا تسۧتطيٰع حظر ⏎ '..IdRank(user, msg.chat_id_), 1, 'md')
else
tdcli_function({ID="ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=user,status_={ID="ChatMemberStatusKicked"},},function(arg,dp) 
if (dp and dp.code_ and dp.code_ == 400 and dp.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_,msg.id_,"*✘ ∫ ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !*") 
...
ReplyStatus(msg,user,"Reply","*✘ ∫ تــمِ حظره من آلَمـجـ̨مـۈعة*")  
end,nil) 
end
end
--         UnBan          --
...
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ الغاء حظره من آلَمـجـ̨مـۈعة*")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
...
ReplyStatus(msg,result.id_,"Reply","*✘ ∫ تــمِ الغاء حظره من آلَمـجـ̨مـۈعة*")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
...
ReplyStatus(msg,user,"Reply","*✘ ∫ تــمِ الغاء حظره من آلَمـجـ̨مـۈعة*")  
end 
end 
--          Mute          --
if Admin(msg) then
...
send(msg.chat_id_, msg.id_,'*✘ ∫ لقد تــمِ تعطيل الكتم والتقيد من قبل المنشئين*')
return false
end
if RankChecking(result.sender_user_id_, result.chat_id_) then
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ لآ تسۧتطيٰع كتم ⏎ * '..IdRank(result.sender_user_id_, msg.chat_id_), 1, 'md')
else
if Devmfm:sismember(mustafa..'mfm:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ هو بالفعل مكتوم من آلَمـجـ̨مـۈعة*")  
else
Devmfm:sadd(mustafa..'mfm:Muted:'..msg.chat_id_, result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ كتـمِـهہ 🤐 من آلَمـجـ̨مـۈعة*")  
end 
end
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
...
if result.id_ then
if RankChecking(result.id_, msg.chat_id_) then
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ لآ تسۧتطيٰع كتم ⏎ * '..IdRank(result.id_, msg.chat_id_), 1, 'md')
else
if Devmfm:sismember(mustafa..'mfm:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","*✘ ∫ هو بالفعل مكتوم من آلَمـجـ̨مـۈعة*")  
else
Devmfm:sadd(mustafa..'mfm:Muted:'..msg.chat_id_, result.id_)
ReplyStatus(msg,result.id_,"Reply","*✘ ∫ تــمِ كتـمِـهہ 🤐 من آلَمـجـ̨مـۈعة*")  
end
end
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
...
if RankChecking(user, msg.chat_id_) then
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ لآ تسۧتطيٰع كتم ⏎ * '..IdRank(user, msg.chat_id_), 1, 'md')
else
if Devmfm:sismember(mustafa..'mfm:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","*✘ ∫ هو بالفعل مكتوم من آلَمـجـ̨مـۈعة*")  
else
Devmfm:sadd(mustafa..'mfm:Muted:'..msg.chat_id_, user)
ReplyStatus(msg,user,"Reply","*✘ ∫ تــمِ كتـمِـهہ 🤐 من آلَمـجـ̨مـۈعة*")  
end
end
end
--         UnMute         --
...
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ هو ليس مكتوم لالغاء كتـمِـهہ 🤐*")  
else
Devmfm:srem(mustafa..'mfm:Muted:'..msg.chat_id_, result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ الغاء كتـمِـهہ 🤐 من آلَمـجـ̨مـۈعة*")  
end
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
...
ReplyStatus(msg,result.id_,"Reply","*✘ ∫ هو ليس مكتوم لالغاء كتـمِـهہ 🤐*")  
else
Devmfm:srem(mustafa..'mfm:Muted:'..msg.chat_id_, result.id_)
ReplyStatus(msg,result.id_,"Reply","*✘ ∫ تــمِ الغاء كتـمِـهہ 🤐 من آلَمـجـ̨مـۈعة*")  
end
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
...
ReplyStatus(msg,user,"Reply","*✘ ∫ هو ليس مكتوم لالغاء كتـمِـهہ 🤐*")  
else
Devmfm:srem(mustafa..'mfm:Muted:'..msg.chat_id_, user)
ReplyStatus(msg,user,"Reply","*✘ ∫ تــمِ الغاء كتـمِـهہ 🤐 من آلَمـجـ̨مـۈعة*")  
end
end 
end 
--          Tkeed           --
...
if RankChecking(result.sender_user_id_, result.chat_id_) then
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ لا تسۧتطيٰع تقيد ⏎ * '..IdRank(result.sender_user_id_, msg.chat_id_), 1, 'md')
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_)
Devmfm:sadd(mustafa..'mfm:Tkeed:'..msg.chat_id_, result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ تقيدِه 🚫 من آلَمـجـ̨مـۈعة")  
end
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
...
if result.id_ then
if RankChecking(result.id_, msg.chat_id_) then
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ لا تسۧتطيٰع تقيد ⏎ * '..IdRank(result.id_, msg.chat_id_), 1, 'md')
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.id_)
Devmfm:sadd(mustafa..'mfm:Tkeed:'..msg.chat_id_, result.id_)
ReplyStatus(msg,result.id_,"Reply","*✘ ∫ تــمِ تقيدِه 🚫 من آلَمـجـ̨مـۈعة*")  
end
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
...
if RankChecking(user, msg.chat_id_) then
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ لآ تسۧتطيٰع تقيد ⏎ * '..IdRank(user, msg.chat_id_), 1, 'md')
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..user)
Devmfm:sadd(mustafa..'mfm:Tkeed:'..msg.chat_id_, user)
ReplyStatus(msg,user,"Reply","*✘ ∫ تــمِ تقيدِه 🚫 من آلَمـجـ̨مـۈعة*")  
end
end
--         UnTkeed          --
...
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ الغاء تقيدِه 🚫 من آلَمـجـ̨مـۈعة*")  
end
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
...
ReplyStatus(msg,result.id_,"Reply","*✘ ∫ تــمِ الغاء تقيدِه 🚫 من آلَمـجـ̨مـۈعة*")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ الغاء تقيدِه 🚫 من آلَمـجـ̨مـۈعة")  
end
end 
end
--         BanAll         --
...
if tonumber(result.sender_user_id_) == tonumber(mustafa) then  
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ *لاتسۧتطيٰع حظر البوت عام*", 1, 'md')
return false 
end
if SudoId(result.sender_user_id_) == true then
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ *لاتسۧتطيٰع حظر المطور الاساسي*", 1, 'md')
return false 
end
ChatKick(result.chat_id_, result.sender_user_id_)
Devmfm:sadd(mustafa..'mfm:BanAll:', result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ حظره عام من المجموعات")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
...
ReplyStatus(msg,result.id_,"Reply","*✘ ∫ تــمِ حظره عام من المجموعات*")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
...
ReplyStatus(msg,user,"Reply","*✘ ∫ تــمِ حظره عام من المجموعات*")  
end
--         MuteAll        --
if text ==('كتم عام') then
function MuteAllReply(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(mustafa) then  
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ *لاتسۧتطيٰع كتم البوت عام*", 1, 'md')
return false 
end
if SudoId(result.sender_user_id_) == true then
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ *لاتسۧتطيٰع كتم المطور الاساسي*", 1, 'md')
return false 
end
Devmfm:sadd(mustafa..'mfm:MuteAll:', result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ كتـمِـهہ 🤐 عام من المجموعات")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
...
ReplyStatus(msg,result.id_,"Reply","*✘ ∫ تــمِ كتـمِـهہ 🤐 عام من المجموعات*")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
...
ReplyStatus(msg,user,"Reply","*✘ ∫ تــمِ كتـمِـهہ 🤐 عام من المجموعات*")  
end
--         UnAll          --
...
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ الغاء (الحظر • الكتم) عام من المجموعات*")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
...
ReplyStatus(msg,result.id_,"Reply","*✘ ∫ تــمِ الغاء (الحظر • الكتم) عام من المجموعات*")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
...
ReplyStatus(msg,user,"Reply","*✘ ∫ تــمِ الغاء (الحظر • الكتم) عام من المجموعات*")  
end
end
end
...
send(msg.chat_id_, msg.id_,'✘ ∫ يجب التاكد ان المطور الجديد آٍࢪسۧل start لخاص البوت بعد ذلك يمكنك ارسال ايدي المطور')
Devmfm:setex(mustafa.."mfm:EditDev"..msg.sender_user_id_,300,true)
end
if Devmfm:get(mustafa.."mfm:EditDev"..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,'*✘ ∫ تــمِ الغاء امر تغير المطور الاساسي*')
...
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ ٍࢪفعـهہ فـيٰ قآإئمـَـهہ المطايه*") 
...
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ هو ليس مطي ليتم تنزيٰلـهہ*") 
else
Devmfm:srem(mustafa..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ تنزيٰلـهہ من قآإئمـَـهہ المطايه*") 
end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,donky_by_reply)
end end
if Admin(msg) then
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ لآ تسۧتطيٰع تقيد ⏎ * '..IdRank(result.sender_user_id_, msg.chat_id_), 1, 'md') 
else 
https.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_..'&until_date='..tonumber(msg.date_+num1))
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ تقيدِه 🚫 لمدة ⏎ * "..mutept.." د") 
Devmfm:sadd(mustafa..'mfm:Tkeed:'..msg.chat_id_, result.sender_user_id_)
end end 
...
https.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_..'&until_date='..tonumber(msg.date_+num1))
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ تقيدِه 🚫 لمدة ⏎ * "..mutept.." س") 
Devmfm:sadd(mustafa..'mfm:Tkeed:'..msg.chat_id_, result.sender_user_id_)
end end
if tonumber(msg.reply_to_message_id_) == 0 then else
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, mut_time,nil) end 
...
https.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..result.sender_user_id_..'&until_date='..tonumber(msg.date_+num1))
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ تقيدِه 🚫 لمدة ⏎ * "..mutept.." ي") 
Devmfm:sadd(mustafa..'mfm:Tkeed:'..msg.chat_id_, result.sender_user_id_)
end end
if tonumber(msg.reply_to_message_id_) == 0 then else
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, mut_time,nil) end 
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "*✘ ∫ آٍࢪسۧل عدد الرسائل الان * \n✘ ∫ آٍࢪسۧل الغاء لالغاء الامر ", 1, "md")
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "*✘ ∫ تــمِ اضافة* "..Num..' رساله', 1, 'md') 
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "*✘ ∫ آٍࢪسۧل عدد النقاط الان * \n✘ ∫ آٍࢪسۧل الغاء لالغاء الامر ", 1, "md")
Dev_mfm(msg.chat_id_, msg.id_, 1,numd, 1, 'md') 
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ هذا الامر للمنشئين فقط', 1, 'md') 
end 
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "*✘ ∫ تــمِ اضافة* "..Num..' نقطه', 1, 'md') 
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},Reply, nil)
return false
end
...
Dev_mfm(msg.chat_id_,msg.id_, 1, "✘ ∫ التثبيت والغاء واعادة التثبيت تــمِ قفله من قبل المنشئين الاساسيين", 1, 'md')
return false  
end
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub("-100",""),message_id_ = msg.reply_to_message_id_,disable_notification_ = 1},function(arg,data) 
if data.ID == "Ok" then
Devmfm:set(mustafa..'mfm:PinnedMsg'..msg.chat_id_,msg.reply_to_message_id_)
local mustafaTEAM = '*✘ ∫ آهـلُِآ عٍزْيـــــــّــزْي ⏎ * '..mfmRank(msg)..' \n *✘ ∫ تــمِ تثبيت الرساله بنجاح*'
mfmmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, mustafaTEAM, 14, string.len(msg.sender_user_id_))
return false  
end
if data.code_ == 6 then
Dev_mfm(msg.chat_id_, msg.id_, 1,'✘ ∫ البوت ليس ادمن هنـآ !', 1, 'md')
return false  
end
...
if text == "المنظفـيٰن" and ChCheck(msg) then 
local List = Devmfm:smembers(mustafa..'mfm:Cleaner:'..msg.chat_id_)
text = "*✘ ∫ قآإئمـَـهہ المنظفـيٰن ⏎ ⥡ * \n┉┉┉┉ EB ┉┉┉┉\n"
for k,v in pairs(List) do
local username = Devmfm:get(mustafa..'Save:UserName'..v)
if username then
text = text..""..k.."~ : [@"..username.."]\n"
...
text = "*✘ ∫ قآإئمـَـهہ آلمـنشـئيٰن آلآسآسيين ⏎ ⥡ * \n┉┉┉┉ EB ┉┉┉┉\n"
for k,v in pairs(List) do
local username = Devmfm:get(mustafa..'Save:UserName'..v)
if username then
text = text..""..k.."~ : [@"..username.."]\n"
...
local UserName = (dp.username_ or "TEAM_Escobar")
Dev_mfm(msg.chat_id_, msg.id_, 1, "*✘ ∫ منشئ آلَمـجـ̨مـۈعة ⏎ * ["..dp.first_name_.."](T.me/"..UserName..")", 1, "md")  
end,nil)   
end
end
end,nil)   
...
text = "*✘ ∫ قآإئمـَـهہ آلمـنع ⏎ ⥡ * \n┉┉┉┉ EB ┉┉┉┉\n"
for k, v in pairs(List) do
text = text..k..'~ ❨ '..v..' ❩\n'
end
if #List == 0 then
text = "*✘ ∫ لآ توجـډ ڪلمـآت مــمـن̀ۈعه*"
end
Dev_mfm(msg.chat_id_, msg.id_, 1, text, 1, 'md')
end
end 
...
text = "*✘ ∫ قآإئمـَـهہ مطاية آلَمـجـ̨مـۈعة 😹💔 ⏎ ⥡ * \n┉┉┉┉ EB ┉┉┉┉\n"
for k,v in pairs(List) do
local username = Devmfm:get(mustafa..'Save:UserName'..v)
if username then
text = text..""..k.."~ : [@"..username.."]\n"
...
if #List == 0 then
text = "✘ ∫ *لآ توجـډ مطايه ڪلهآ آوآډم* 😹💔"
end
Dev_mfm(msg.chat_id_, msg.id_, 1, text, 1, "md")
end
...
text = "✘ ∫ قآإئمـَـهہ المطورين الثانويين ⏎ ⥡ \n┉┉┉┉ EB ┉┉┉┉\n"
for k,v in pairs(List) do
local username = Devmfm:get(mustafa..'Save:UserName'..v)
if username then
text = text..""..k.."~ : [@"..username.."]\n"
...
if #List == 0 then
text = "✘ ∫ *عــــــــذرآ لم يتم رفع اي مطورين ثانويين*"
end
Dev_mfm(msg.chat_id_, msg.id_, 1, text, 1, "md")
end 
if SudoBot(msg) then
...
if #BanAll ~= 0 then 
text = "*✘ ∫ قآإئمـَـهہ آلمـحـظوٍࢪيٰن عـآم  ⏎ ⥡ * \n┉┉┉┉ EB ┉┉┉┉\n"
...
if #MuteAll ~= 0 then 
text = text.."*✘ ∫ قآإئمـَـهہ آلمـڪتومـيٰن عـآم ⏎ ⥡ * \n┉┉┉┉ EB ┉┉┉┉\n"
...
text = "*✘ ∫ قآإئمـَـهہ آلمـميٰزين آلعـآم ⏎ ⥡ * \n┉┉┉┉ EB ┉┉┉┉\n"
for k,v in pairs(List) do
local username = Devmfm:get(mustafa..'Save:UserName'..v)
if username then
text = text..""..k.."~ : [@"..username.."]\n"
...
local List = Devmfm:smembers(mustafa..mfm)
text = "*✘ ∫ قآإئمـَـهہ آلآډمـنيهہ آلعـآمين ⏎ ⥡ * \n┉┉┉┉ EB ┉┉┉┉\n"
for k,v in pairs(List) do
local username = Devmfm:get(mustafa..'Save:UserName'..v)
if username then
text = text..""..k.."~ : [@"..username.."]\n"
...
local UserName = (dp.username_ or "TEAM_Escobar")
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ تــمِ رفع منشئ آلَمـجـ̨مـۈعة ⏎ ["..dp.first_name_.."](T.me/"..UserName..")", 1, "md") 
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ منع الملصق بنجاح لن يتم ارساله مجددا', 1, 'md')
return false
end
if result.content_.ID == "MessagePhoto" then
local photo = result.content_.photo_.id_
Devmfm:sadd(mustafa.."mfm:FilterPhoto"..msg.chat_id_,photo)
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ منع الصوره بنجاح لن يتم ارسالها مجددا', 1, 'md')
return false
end
if result.content_.animation_ then
local idanimation = result.content_.animation_.animation_.persistent_id_
Devmfm:sadd(mustafa.."mfm:FilterAnimation"..msg.chat_id_,idanimation)
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ منع المتحركه بنجاح لن يتم ارسالها مجددا', 1, 'md')
return false
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ الغاء منع الملصق يمكنهم ارساله الان', 1, 'md')
return false
end
if result.content_.ID == "MessagePhoto" then
local photo = result.content_.photo_.id_
Devmfm:srem(mustafa.."mfm:FilterPhoto"..msg.chat_id_,photo)
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ الغاء منع الصوره يمكنهم ارسالها الان', 1, 'md')
return false
end
if result.content_.animation_.animation_ then
local idanimation = result.content_.animation_.animation_.persistent_id_
Devmfm:srem(mustafa.."mfm:FilterAnimation"..msg.chat_id_,idanimation)
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ الغاء منع المتحركه يمكنهم ارسالها الان', 1, 'md')
return false
end
end
...
sendPhoto(msg.chat_id_, msg.id_, 0, 1,nil, './'..msg.sender_user_id_..'.jpg','*✘ ∫ تــمِ تحويل الملصق الى صوره*')     
...
sendVoice(msg.chat_id_, msg.id_, 0, 1,nil, './'..msg.sender_user_id_..'.ogg',"*✘ ∫ تــمِ تحويل الـMp3 الى بصمه*")
...
ReplyStatus(msg,result.sender_user_id_,"Reply","*✘ ∫ تــمِ رفع قيوده*")  
HTTPS.request("https://api.telegram.org/bot" .. TokenBot .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
...
ReplyStatus(msg,user,"Reply","*✘ ∫ تــمِ رفع قيوده*")  
HTTPS.request("https://api.telegram.org/bot" .. TokenBot .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
...
ReplyStatus(msg,result.id_,"Reply","*✘ ∫ 🔰تــمِ رفع قيوده*")  
HTTPS.request("https://api.telegram.org/bot" .. TokenBot .. "/restrictChatMember?chat_id=" ..msg.chat_id_.. "&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ تغير كليشة الايدي")  
end
if SecondSudo(msg) then
if text and text:match("^تعيين الايدي العام$") or text and text:match("^تعين الايدي العام$") or text and text:match("^تعيين كليشة الايدي$") then
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ رجائا اتبع التعليمات للتعيين \n✘ ∫ لطبع كليشة الايدي آٍࢪسۧل كليشه تحتوي على النصوص التي باللغه الانجليزيه ادناه ⏎ ⥡\n┉┉┉┉ EB ┉┉┉┉\n `#username` ↬ لطبع المعرف\n `#id` ↬ لطبع الايدي \n `#photos` ↬ لطبع عدد الصور \n `#stast` ↬ لطبع الرتب \n `#msgs` ↬ لطبع عدد الرسائل \n `#msgday` ↬ لطبع الرسائل اليوميه \n `#CustomTitle` ↬ لطبع اللقب \n `#bio` ↬ لطبع البايو \n `#auto` ↬ لطبع التفاعل \n `#game` ↬ لطبع عدد النقاط \n `#cont` ↬ لطبع عدد الجهات \n `#edit` ↬ لطبع عدد السحكات \n `#Description` ↬ لطبع تعليق الصور\n┉┉┉┉ EB ┉┉┉┉', 1, 'md')
...
Devmfm:del("mustafa:New:id:"..mustafa..msg.sender_user_id_)
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ حفظ كليشة الايدي العامه', 1, 'md')
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ حذف كليشة الايدي العامه")  
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ حذف كليشة الايدي")  
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ قفل التعديل")  
Devmfm:set(mustafa..'mfm:Lock:EditMsgs'..msg.chat_id_,true)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ التعديل بالفعل مقفل فـيٰ آلَمـجـ̨مـۈعة*', 1, 'md')
end
end
if LockText[2] == "التعديل الميديا" or LockText[2] == "تعديل الميديا" then
if not Devmfm:get(mustafa..'mfm:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ قفل تعديل الميديا")  
Devmfm:set(mustafa..'mfm:Lock:EditMsgs'..msg.chat_id_,true)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ تعديل الميديا بالفعل مقفل فـيٰ آلَمـجـ̨مـۈعة*', 1, 'md')
end
end
if LockText[2] == "الفارسيه" then
if not Devmfm:get(mustafa..'mfm:Lock:Farsi'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ قفل الفارسيه")  
Devmfm:set(mustafa..'mfm:Lock:Farsi'..msg.chat_id_,true)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ الفارسيه بالفعل مقفله فـيٰ آلَمـجـ̨مـۈعة*', 1, 'md')
end
end
if LockText[2] == "الفشار" then
if Devmfm:get(mustafa..'mfm:Lock:Fshar'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ قفل الفشار")  
Devmfm:del(mustafa..'mfm:Lock:Fshar'..msg.chat_id_)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ الفشار بالفعل مقفل فـيٰ آلَمـجـ̨مـۈعة*', 1, 'md')
end
end
if LockText[2] == "الطائفيه" then
if Devmfm:get(mustafa..'mfm:Lock:Taf'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ قفل الطائفـيٰه*")  
Devmfm:del(mustafa..'mfm:Lock:Taf'..msg.chat_id_)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ الطائفـيٰه بالفعل مقفله فـيٰ آلَمـجـ̨مـۈعة*', 1, 'md')
end
end
if LockText[2] == "الكفر" then
if Devmfm:get(mustafa..'mfm:Lock:Kfr'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ قفل الكفر")  
Devmfm:del(mustafa..'mfm:Lock:Kfr'..msg.chat_id_)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ الكفر بالفعل مقفل فـيٰ آلَمـجـ̨مـۈعة*', 1, 'md')
end
end
if LockText[2] == "الفارسيه بالطرد" then
if not Devmfm:get(mustafa..'mfm:Lock:FarsiBan'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ قفل الفارسيه بالطرد*")  
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ قفل البوتات بالحذف*")  
Devmfm:set(mustafa.."mfm:Lock:Bots"..msg.chat_id_,"del")  
end
if LockText[2] == "البوتات بالطرد" then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ قفل البوتات بالطرد*")  
Devmfm:set(mustafa.."mfm:Lock:Bots"..msg.chat_id_,"kick")  
end
if LockText[2] == "البوتات بالتقييد" or LockText[2] == "البوتات بالتقيد" then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ قفل البوتات بالتقيد*")  
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ قفل التكرار بالحذف*")  
end
if LockText[2] == "التكرار بالطرد" then 
Devmfm:hset(mustafa.."mfm:Spam:Group:User"..msg.chat_id_ ,"Spam:User","kick")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ قفل التكرار بالطرد*")  
end
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ قفل التكرار بالتقيد*")  
end
if LockText[2] == "التكرار بالكتم" then 
Devmfm:hset(mustafa.."mfm:Spam:Group:User"..msg.chat_id_ ,"Spam:User","mute")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ قفل التكرار بالكتم*")  
end
if BasicConstructor(msg) then
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ قفل التثبيت*")  
Devmfm:set(mustafa..'mfm:Lock:Pin'..msg.chat_id_,true)
Devmfm:sadd(mustafa.."mfm:Lock:Pinpin",msg.chat_id_) 
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ التثبيت بالفعل مقفل فـيٰ آلَمـجـ̨مـۈعة*', 1, 'md')
end end end
end
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ تــمِ وضع عدد التكرار ⏎ * '..TextSpam, 1, 'md')
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ تــمِ وضع زمن التكرار ⏎ * '..TextSpam, 1, 'md')
end
if Manager(msg) then
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ الايدي بالصوره بالتاكيد مـعـطل*', 1, 'md')
else
local mustafaTEAM = '*✘ ∫ آهـلُِآ عٍزْيـــــــّــزْي ⏎ * '..mfmRank(msg)..' \n*✘ ∫ تــمِ تعطيل الايدي بالصوره*'
mfmmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, mustafaTEAM, 14, string.len(msg.sender_user_id_))
...
local mustafaTEAM = '*✘ ∫ آهـلُِآ عٍزْيـــــــّــزْي ⏎ * '..mfmRank(msg)..' \n*✘ ∫ تــمِ تفعيل الايدي بنجاح*'
mfmmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, mustafaTEAM, 14, string.len(msg.sender_user_id_))
Devmfm:del(mustafa..'mfm:Lock:Id'..msg.chat_id_)
end end 
if text and text == 'تعطيل الايدي' and ChCheck(msg) then
if Devmfm:get(mustafa..'mfm:Lock:Id'..msg.chat_id_) then
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ الايدي بالتاكيد مـعـطل* ', 1, 'md')
else
local mustafaTEAM = '*✘ ∫ آهـلُِآ عٍزْيـــــــّــزْي ⏎ * '..mfmRank(msg)..' \n*✘ ∫ تــمِ تعطيل الايدي بنجاح*'
mfmmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, mustafaTEAM, 14, string.len(msg.sender_user_id_))
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ آٍࢪسۧل رابط آلَمـجـ̨مـۈعة او رابط قناة آلَمـجـ̨مـۈعة*', 1, 'md')
...
LinkGroup = LinkGp.result
Devmfm:set(mustafa.."mfm:Groups:Links"..msg.chat_id_,LinkGroup) 
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ تــمِ انشاء رابط جديد آٍࢪسۧل ⏎ الرابط*', 1, 'md')
else
...
if text == 'الغاء' then 
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ تــمِ الغاء حفظ كليشة الترحيب*', 1, 'md')
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ تــمِ حفظ كليشة الترحيب*', 1, 'md')
return false   
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ آٍࢪسۧل لي الترحيب الان *\n*✘ ∫ تسۧتطيٰع اضافة مايلي ⏎ ⥡ *\n *✘ ∫ دالة عرض الاسم ⏎ firstname *\n*✘ ∫ دالة عرض المعرف ⏎ username *', 1, 'md')
Devmfm:set(mustafa..'mfm:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
if text and text:match("^حذف الترحيب$") and ChCheck(msg) or text and text:match("^حذف ترحيب$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ حذف الترحيب*")  
...
if text == 'الغاء' then 
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ تــمِ الغاء امر المنع*', 1, 'md')
Devmfm:del(mustafa.."mfm:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
Dev_mfm(msg.chat_id_, msg.id_, 1, "*✘ ∫ تــمِ منع الكلمه ⏎ * "..text, 1, 'html')
Devmfm:del(mustafa.."mfm:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
...
if text == 'الغاء' then 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ الغاء امر الغاء المنع', 1, 'md')
Devmfm:del(mustafa.."mfm:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
if not Devmfm:hget(mustafa..'mfm:Filters:'..msg.chat_id_, text) then  
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ الكلمه ⏎ "..text.." غير مــمـن̀ۈعه", 1, 'html')
Devmfm:del(mustafa.."mfm:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
else
Devmfm:hdel(mustafa..'mfm:Filters:'..msg.chat_id_, text)
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ الكلمه ⏎ "..text.." تــمِ الغاء منعها", 1, 'html')
Devmfm:del(mustafa.."mfm:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
end
return false
end
...
if Number > 1000 then 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ لاتسۧتطيٰع تنظيف اكثر من 1000 رساله', 1, 'md')
return false  
end  
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ تنظيف *'..Number..'* من الرسائل', 1, 'md')
...
mustafagp2 = '\n✘ ∫ تــمِ حذف ⏎ { '..q..' } مجموعه من البوت'
end
if w == 0 then
mustafagp1 = ''
else
mustafagp1 = '\n✘ ∫ تــمِ حذف ⏎ { '..w..' } مجموعه بسبب تنزيل البوت الى عضــوُ'
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ لاتوجد ميديا هنـآ", 1, 'md') 
end end
...
if Del ~= 0 then
Dev_mfm(msg.chat_id_, msg.id_, 1, "*✘ ∫ تــمِ حذف* "..Del.."* من الميديا*", 1, 'md') 
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ تــمِ تنظيف 100 من الرسائل المعدله*', 1, 'md')
end
if ChatType == 'sp' or ChatType == 'gp'  then
if Admin(msg) then
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ فتح التعديل")  
Devmfm:del(mustafa..'mfm:Lock:EditMsgs'..msg.chat_id_)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ التعديل بالفعل مفتوح فـيٰ آلَمـجـ̨مـۈعة', 1, 'md')
end
end
if UnLockText[2] == "التعديل الميديا" or UnLockText[2] == "تعديل الميديا" then
if Devmfm:get(mustafa..'mfm:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ فتح تعديل الميديا*")  
Devmfm:del(mustafa..'mfm:Lock:EditMsgs'..msg.chat_id_)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تعديل الميديا بالفعل مفتوح فـيٰ آلَمـجـ̨مـۈعة', 1, 'md')
end
end
if UnLockText[2] == "الفارسيه" then
if Devmfm:get(mustafa..'mfm:Lock:Farsi'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ فتح الفارسيه*")  
Devmfm:del(mustafa..'mfm:Lock:Farsi'..msg.chat_id_)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الفارسيه بالفعل مفتوحه فـيٰ آلَمـجـ̨مـۈعة', 1, 'md')
end
end
if UnLockText[2] == "الفشار" then
if not Devmfm:get(mustafa..'mfm:Lock:Fshar'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ فتح الفشار")  
Devmfm:set(mustafa..'mfm:Lock:Fshar'..msg.chat_id_,true)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الفشار بالفعل مفتوح فـيٰ آلَمـجـ̨مـۈعة', 1, 'md')
end
end
if UnLockText[2] == "الطائفيه" then
if not Devmfm:get(mustafa..'mfm:Lock:Taf'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ فتح الطائفـيٰه")  
Devmfm:set(mustafa..'mfm:Lock:Taf'..msg.chat_id_,true)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الطائفـيٰه بالفعل مفتوحه فـيٰ آلَمـجـ̨مـۈعة', 1, 'md')
end
end
if UnLockText[2] == "الكفر" then
if not Devmfm:get(mustafa..'mfm:Lock:Kfr'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ فتح الكفر")  
Devmfm:set(mustafa..'mfm:Lock:Kfr'..msg.chat_id_,true)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الكفر بالفعل مفتوح فـيٰ آلَمـجـ̨مـۈعة', 1, 'md')
end
end
if UnLockText[2] == "الفارسيه بالطرد" then
if Devmfm:get(mustafa..'mfm:Lock:FarsiBan'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ فتح الفارسيه بالطرد")  
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ فتح البوتات")  
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ فتح التكرار")  
end
if BasicConstructor(msg) then
if UnLockText[2] == "التثبيت" then
if Devmfm:get(mustafa..'mfm:Lock:Pin'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ فتح التثبيت")  
Devmfm:del(mustafa..'mfm:Lock:Pin'..msg.chat_id_)
Devmfm:srem(mustafa.."mfm:Lock:Pinpin",msg.chat_id_)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ التثبيت بالفعل مفتوح فـيٰ آلَمـجـ̨مـۈعة', 1, 'md')
end end end
end
end
if Admin(msg) then
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ قفل الدردشه*")  
Devmfm:set(mustafa..'mfm:Lock:Text'..msg.chat_id_,true)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ الدردشه بالفعل مقفله فـيٰ آلَمـجـ̨مـۈعة*', 1, 'md')
end
end
if LockText[2] == "الاونلاين" then
if not Devmfm:get(mustafa..'mfm:Lock:Inline'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ قفل الاونلاين")  
Devmfm:set(mustafa..'mfm:Lock:Inline'..msg.chat_id_,true)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الاونلاين بالفعل مقفل فـيٰ آلَمـجـ̨مـۈعة', 1, 'md')
end
end
if LockText[2] == "الصور" then
if not Devmfm:get(mustafa..'mfm:Lock:Photo'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ قفل الصور")  
Devmfm:set(mustafa..'mfm:Lock:Photo'..msg.chat_id_,true)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الصور بالفعل مقفله فـيٰ آلَمـجـ̨مـۈعة', 1, 'md')
end
end
if LockText[2] == "الكلايش" then
if not Devmfm:get(mustafa..'mfm:Lock:Spam'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ قفل الكلايش")  
Devmfm:set(mustafa..'mfm:Lock:Spam'..msg.chat_id_,true)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الكلايش بالفعل مقفله فـيٰ آلَمـجـ̨مـۈعة', 1, 'md')
end
end
if LockText[2] == "الدخول" then
if not Devmfm:get(mustafa..'mfm:Lock:Join'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ قفل الدخول")  
Devmfm:set(mustafa..'mfm:Lock:Join'..msg.chat_id_,true)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الدخول بالفعل مقفل فـيٰ آلَمـجـ̨مـۈعة', 1, 'md')
end
end
if LockText[2] == "الفيديو" then
if not Devmfm:get(mustafa..'mfm:Lock:Videos'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ قفل الفـيٰديو")  
Devmfm:set(mustafa..'mfm:Lock:Videos'..msg.chat_id_,true)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الفـيٰديو بالفعل مقفل فـيٰ آلَمـجـ̨مـۈعة', 1, 'md')
end
end
if LockText[2] == "المتحركه" then
if not Devmfm:get(mustafa..'mfm:Lock:Gifs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ قفل المتحركه")  
Devmfm:set(mustafa..'mfm:Lock:Gifs'..msg.chat_id_,true)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ المتحركه بالفعل مقفله فـيٰ آلَمـجـ̨مـۈعة', 1, 'md')
end
end
if LockText[2] == "الاغاني" then
if not Devmfm:get(mustafa..'mfm:Lock:Music'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ قفل الاغاني")  
Devmfm:set(mustafa..'mfm:Lock:Music'..msg.chat_id_,true)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الاغاني بالفعل مقفله فـيٰ آلَمـجـ̨مـۈعة', 1, 'md')
end
end
if LockText[2] == "الصوت" then
if not Devmfm:get(mustafa..'mfm:Lock:Voice'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ قفل الصوت")  
Devmfm:set(mustafa..'mfm:Lock:Voice'..msg.chat_id_,true)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الصوت بالفعل مقفل فـيٰ آلَمـجـ̨مـۈعة', 1, 'md')
end
end
if LockText[2] == "الروابط" then
if not Devmfm:get(mustafa..'mfm:Lock:Links'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ قفل الروابط")  
Devmfm:set(mustafa..'mfm:Lock:Links'..msg.chat_id_,true)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الروابط بالفعل مقفله فـيٰ آلَمـجـ̨مـۈعة', 1, 'md')
end
end
if LockText[2] == "المواقع" then
if not Devmfm:get(mustafa..'mfm:Lock:Location'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ قفل المواقع")  
Devmfm:set(mustafa..'mfm:Lock:Location'..msg.chat_id_,true)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ المواقع بالفعل مقفله فـيٰ آلَمـجـ̨مـۈعة', 1, 'md')
end
end
if LockText[2] == "المعرف" or LockText[2] == "المعرفات" then
if not Devmfm:get(mustafa..'mfm:Lock:Tags'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ قفل المعرفات")  
Devmfm:set(mustafa..'mfm:Lock:Tags'..msg.chat_id_,true)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ المعرفات بالفعل مقفله فـيٰ آلَمـجـ̨مـۈعة', 1, 'md')
end
end
if LockText[2] == "الملفات" then
if not Devmfm:get(mustafa..'mfm:Lock:Document'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ قفل الملفات")  
Devmfm:set(mustafa..'mfm:Lock:Document'..msg.chat_id_,true)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الملفات بالفعل مقفله فـيٰ آلَمـجـ̨مـۈعة', 1, 'md')
end
end
if LockText[2] == "الهاشتاك" or LockText[2] == "التاك" then
if not Devmfm:get(mustafa..'mfm:Lock:Hashtak'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ قفل الهاشتاك")  
Devmfm:set(mustafa..'mfm:Lock:Hashtak'..msg.chat_id_,true)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الهاشتاك بالفعل مقفل فـيٰ آلَمـجـ̨مـۈعة', 1, 'md')
end
end
if LockText[2] == "الجهات" then
if not Devmfm:get(mustafa..'mfm:Lock:Contact'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ قفل الجهات")  
Devmfm:set(mustafa..'mfm:Lock:Contact'..msg.chat_id_,true)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '️✘ ∫ الجهات بالفعل مقفله فـيٰ آلَمـجـ̨مـۈعة', 1, 'md')
end
end
if LockText[2] == "الشبكات" then
if not Devmfm:get(mustafa..'mfm:Lock:WebLinks'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ قفل الشبكات")  
Devmfm:set(mustafa..'mfm:Lock:WebLinks'..msg.chat_id_,true) 
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الشبكات بالفعل مقفله فـيٰ آلَمـجـ̨مـۈعة', 1, 'md')
end
end
if LockText[2] == "العربيه" then
if not Devmfm:get(mustafa..'mfm:Lock:Arabic'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ قفل العربيه*")  
Devmfm:set(mustafa..'mfm:Lock:Arabic'..msg.chat_id_,true)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ العربيه بالفعل مقفله فـيٰ آلَمـجـ̨مـۈعة', 1, 'md')
end
end
if LockText[2] == "الانكليزيه" then
if not Devmfm:get(mustafa..'mfm:Lock:English'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ قفل الانكليزيه*")  
Devmfm:set(mustafa..'mfm:Lock:English'..msg.chat_id_,true)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الانكليزيه بالفعل مقفله فـيٰ آلَمـجـ̨مـۈعة', 1, 'md')
end
end
if LockText[2] == "الملصقات" then
if not Devmfm:get(mustafa..'mfm:Lock:Stickers'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ قفل الملصقات*")  
Devmfm:set(mustafa..'mfm:Lock:Stickers'..msg.chat_id_,true)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ الملصقات بالفعل مقفله فـيٰ آلَمـجـ̨مـۈعة*', 1, 'md')
end
end
if LockText[2] == "الماركداون" then
if not Devmfm:get(mustafa..'mfm:Lock:Markdown'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ قفل الماركداون*")  
Devmfm:set(mustafa..'mfm:Lock:Markdown'..msg.chat_id_,true)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ الماركداون بالفعل مقفل فـيٰ آلَمـجـ̨مـۈعة*', 1, 'md')
end
end
if LockText[2] == "الاشعارات" then
if not Devmfm:get(mustafa..'mfm:Lock:TagServr'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ قفل الاشعارات*")  
Devmfm:set(mustafa..'mfm:Lock:TagServr'..msg.chat_id_,true)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ الاشعارات بالفعل مقفله فـيٰ آلَمـجـ̨مـۈعة*', 1, 'md')
end
end
if LockText[2] == "التوجيه" then
if not Devmfm:get(mustafa..'mfm:Lock:Forwards'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ قفل التوجيه")  
Devmfm:set(mustafa..'mfm:Lock:Forwards'..msg.chat_id_,true)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ التوجيه بالفعل مقفل فـيٰ آلَمـجـ̨مـۈعة*', 1, 'md')
end
end
end
end
...
if Devmfm:get(mustafa..'mfm:Lock:Text'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ فتح الدردشه*")  
Devmfm:del(mustafa..'mfm:Lock:Text'..msg.chat_id_)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ الدردشه بالفعل مفتوحه فـيٰ آلَمـجـ̨مـۈعة*', 1, 'md')
end
end
if UnLockText[2] == "الصور" then
if Devmfm:get(mustafa..'mfm:Lock:Photo'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ فتح الصور*")  
Devmfm:del(mustafa..'mfm:Lock:Photo'..msg.chat_id_)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ الصور بالفعل مفتوحه فـيٰ آلَمـجـ̨مـۈعة*', 1, 'md')
end
end
if UnLockText[2] == "الكلايش" then
if Devmfm:get(mustafa..'mfm:Lock:Spam'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ فتح الكلايش*")  
Devmfm:del(mustafa..'mfm:Lock:Spam'..msg.chat_id_)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ الكلايش بالفعل مفتوحه فـيٰ آلَمـجـ̨مـۈعة*', 1, 'md')
end
end
if UnLockText[2] == "الدخول" then
if Devmfm:get(mustafa..'mfm:Lock:Join'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ فتح الدخول*")  
Devmfm:del(mustafa..'mfm:Lock:Join'..msg.chat_id_)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ الدخول بالفعل مفتوح فـيٰ آلَمـجـ̨مـۈعة*', 1, 'md')
end
end
if UnLockText[2] == "الفيديو" then
if Devmfm:get(mustafa..'mfm:Lock:Videos'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ فتح الفـيٰديو*")  
Devmfm:del(mustafa..'mfm:Lock:Videos'..msg.chat_id_)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ الفـيٰديو بالفعل مفتوحه فـيٰ آلَمـجـ̨مـۈعة*', 1, 'md')
end
end
if UnLockText[2] == "الملفات" then
if Devmfm:get(mustafa..'mfm:Lock:Document'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ فتح الملفات*")  
Devmfm:del(mustafa..'mfm:Lock:Document'..msg.chat_id_)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ الملفات بالفعل مفتوحه فـيٰ آلَمـجـ̨مـۈعة*', 1, 'md')
end
end
if UnLockText[2] == "الاونلاين" then
if Devmfm:get(mustafa..'mfm:Lock:Inline'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ فتح الاونلاين*")  
Devmfm:del(mustafa..'mfm:Lock:Inline'..msg.chat_id_)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ الاونلاين بالفعل مفتوحه فـيٰ آلَمـجـ̨مـۈعة*', 1, 'md')
end
end
if UnLockText[2] == "الماركداون" then
if Devmfm:get(mustafa..'mfm:Lock:Markdown'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ فتح الماركداون*")  
Devmfm:del(mustafa..'mfm:Lock:Markdown'..msg.chat_id_)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ الماركداون بالفعل مفتوحه فـيٰ آلَمـجـ̨مـۈعة*', 1, 'md')
end
end
if UnLockText[2] == "المتحركه" then
if Devmfm:get(mustafa..'mfm:Lock:Gifs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ فتح المتحركه*")  
Devmfm:del(mustafa..'mfm:Lock:Gifs'..msg.chat_id_)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ المتحركه بالفعل مفتوحه فـيٰ آلَمـجـ̨مـۈعة*', 1, 'md')
end
end
if UnLockText[2] == "الاغاني" then
if Devmfm:get(mustafa..'mfm:Lock:Music'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ فتح الاغاني*")  
Devmfm:del(mustafa..'mfm:Lock:Music'..msg.chat_id_)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ الاغاني بالفعل مفتوحه فـيٰ آلَمـجـ̨مـۈعة*', 1, 'md')
end
end
if UnLockText[2] == "الصوت" then
if Devmfm:get(mustafa..'mfm:Lock:Voice'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ فتح الصوت*")  
Devmfm:del(mustafa..'mfm:Lock:Voice'..msg.chat_id_)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ الصوت بالفعل مفتوحه فـيٰ آلَمـجـ̨مـۈعة*', 1, 'md')
end
end
if UnLockText[2] == "الروابط" then
if Devmfm:get(mustafa..'mfm:Lock:Links'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ فتح الروابط*")  
Devmfm:del(mustafa..'mfm:Lock:Links'..msg.chat_id_)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ الروابط بالفعل مفتوحه فـيٰ آلَمـجـ̨مـۈعة*', 1, 'md')
end
end
if UnLockText[2] == "المواقع" then
if Devmfm:get(mustafa..'mfm:Lock:Location'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ فتح المواقع*")  
Devmfm:del(mustafa..'mfm:Lock:Location'..msg.chat_id_)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ المواقع بالفعل مفتوحه فـيٰ آلَمـجـ̨مـۈعة*', 1, 'md')
end
end
if UnLockText[2] == "المعرف" or UnLockText[2] == "المعرفات" then
if Devmfm:get(mustafa..'mfm:Lock:Tags'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ فتح المعرفات*")  
Devmfm:del(mustafa..'mfm:Lock:Tags'..msg.chat_id_)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ المعرفات بالفعل مفتوحه فـيٰ آلَمـجـ̨مـۈعة*', 1, 'md')
end
end
if UnLockText[2] == "الهاشتاك" or UnLockText[2] == "التاك" then
if Devmfm:get(mustafa..'mfm:Lock:Hashtak'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ فتح الهاشتاك*")  
Devmfm:del(mustafa..'mfm:Lock:Hashtak'..msg.chat_id_)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ الهاشتاك بالفعل مفتوحه فـيٰ آلَمـجـ̨مـۈعة*', 1, 'md')
end
end
if UnLockText[2] == "الجهات" then
if Devmfm:get(mustafa..'mfm:Lock:Contact'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ فتح الجهات*")  
Devmfm:del(mustafa..'mfm:Lock:Contact'..msg.chat_id_)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الجهات بالفعل مفتوحه فـيٰ آلَمـجـ̨مـۈعة', 1, 'md')
end
end
if UnLockText[2] == "الشبكات" then
if Devmfm:get(mustafa..'mfm:Lock:WebLinks'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ فتح الشبكات*")  
Devmfm:del(mustafa..'mfm:Lock:WebLinks'..msg.chat_id_)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الشبكات بالفعل مفتوحه فـيٰ آلَمـجـ̨مـۈعة', 1, 'md')
end
end
if UnLockText[2] == "العربيه" then
if Devmfm:get(mustafa..'mfm:Lock:Arabic'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ فتح العربيه*")  
Devmfm:del(mustafa..'mfm:Lock:Arabic'..msg.chat_id_)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ العربيه بالفعل مفتوحه فـيٰ آلَمـجـ̨مـۈعة', 1, 'md')
end
end
if UnLockText[2] == "الانكليزيه" then
if Devmfm:get(mustafa..'mfm:Lock:English'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ فتح الانكليزيه*")  
Devmfm:del(mustafa..'mfm:Lock:English'..msg.chat_id_)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الانكليزيه بالفعل مفتوحه فـيٰ آلَمـجـ̨مـۈعة', 1, 'md')
end
end
if UnLockText[2] == "الاشعارات" then
if Devmfm:get(mustafa..'mfm:Lock:TagServr'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ فتح الاشعارات*")  
Devmfm:del(mustafa..'mfm:Lock:TagServr'..msg.chat_id_)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الاشعارات بالفعل مفتوحه فـيٰ آلَمـجـ̨مـۈعة', 1, 'md')
end
end
if UnLockText[2] == "الملصقات" then
if Devmfm:get(mustafa..'mfm:Lock:Stickers'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ فتح الملصقات*")  
Devmfm:del(mustafa..'mfm:Lock:Stickers'..msg.chat_id_)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الملصقات بالفعل مفتوحه فـيٰ آلَمـجـ̨مـۈعة', 1, 'md')
end
end
if UnLockText[2] == "التوجيه" then
if Devmfm:get(mustafa..'mfm:Lock:Forwards'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ فتح التوجيه*")  
Devmfm:del(mustafa..'mfm:Lock:Forwards'..msg.chat_id_)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ التوجيه بالفعل مفتوح فـيٰ آلَمـجـ̨مـۈعة', 1, 'md')
end
end
end
end
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ قفل التفليش*")  
end
end
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ فتح التفليش*")  
end
end
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ قفل جميع الاوامر*")  
end
end
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ فتح جميع الاوامر*")  
end
end
if Admin(msg) then
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ تــمِ وضع عدد السبام ⏎ *'..SetSpam, 1, 'md')
end
end
end
if Manager(msg) then
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ تــمِ تغير رد المطور الى ⏎ "..Text, 1, 'md')
end
if text and text:match("^تغير رد منشئ الاساسي (.*)$") then
local Text = text:match("^تغير رد منشئ الاساسي (.*)$") 
Devmfm:set(mustafa.."mfm:BasicConstructor:Rd"..msg.chat_id_,Text)
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ تــمِ تغير رد المنشئ الاساسي الى ⏎ "..Text, 1, 'md')
end
if text and text:match("^تغير رد المنشئ (.*)$") then
local Text = text:match("^تغير رد المنشئ (.*)$") 
Devmfm:set(mustafa.."mfm:Constructor:Rd"..msg.chat_id_,Text)
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ تــمِ تغير رد المنشئ الى ⏎ "..Text, 1, 'md')
end
if text and text:match("^تغير رد المدير (.*)$") then
local Text = text:match("^تغير رد المدير (.*)$") 
Devmfm:set(mustafa.."mfm:Managers:Rd"..msg.chat_id_,Text) 
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ تــمِ تغير رد المدير الى ⏎ "..Text, 1, 'md')
end
if text and text:match("^تغير رد الادمن (.*)$") then
local Text = text:match("^تغير رد الادمن (.*)$") 
Devmfm:set(mustafa.."mfm:Admins:Rd"..msg.chat_id_,Text)
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ تــمِ تغير رد الادمن الى ⏎ "..Text, 1, 'md')
end
if text and text:match("^تغير رد المميز (.*)$") then
local Text = text:match("^تغير رد المميز (.*)$") 
Devmfm:set(mustafa.."mfm:VipMem:Rd"..msg.chat_id_,Text)
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ تــمِ تغير رد المميز الى ⏎ "..Text, 1, 'md')
end
if text and text:match("^تغير رد المنظف (.*)$") then
local Text = text:match("^تغير رد المنظف (.*)$") 
Devmfm:set(mustafa.."mfm:Cleaner:Rd"..msg.chat_id_,Text)
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ تــمِ تغير رد المنظف الى ⏎ "..Text, 1, 'md')
end
if text and text:match("^تغير رد آلَعضــوُ (.*)$") then
local Text = text:match("^تغير رد آلَعضــوُ (.*)$") 
Devmfm:set(mustafa.."mfm:mem:Rd"..msg.chat_id_,Text)
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ تــمِ تغير رد آلَعضــوُ الى ⏎ "..Text, 1, 'md')
end
if text == "حذف ردود الرتب" or text == "مسح ردود الرتب" then
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ تــمِ حذف جميع ردود الرتب", 1, 'md')
...
if #admins == 0 then
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ *لاتوجد بـوتآت هنـآ*", 1, 'md')
return false end
if #admins == i then 
local a = '┉┉┉┉ EB ┉┉┉┉\n✘ ∫ *عدد آلبـوتآت هنـآ* ⏎ '..n..'\n'
local f = '✘ ∫ *عدد آلبـوتآت المرفوعه* ⏎ '..t..'\n✘ ∫ *ملاحضه علامة الـ*✯ *تعني ان البوت ادمن فـيٰ هذه آلَمـجـ̨مـۈعة*'
...
if (c - x) == 0 then
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ *لاتوجد بوتات هنـآ*", 1, 'md')
else
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ *عدد البوتات هنـآ* ⏎ "..c.."\n✘ ∫ *عدد البوتات المرفوعه* ⏎ "..x.."\n✘ ∫ *تــمِ طرد* ⏎ "..(c - x).." *من البوتات*", 1, 'md')
end 
end,nil)  
end 
end
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ حـذ٘ف آلمـطوٍࢪين اݪثـأنوٰيين*")  
end
end
if SecondSudo(msg) then 
if txts[2] == 'المطورين' or txtss[2] == 'المطورين' then
Devmfm:del(mustafa..'mfm:SudoBot:')
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ حـذ٘ف آلمـطوٍࢪين*")  
end
if txts[2] == 'قائمه العام' or txtss[2] == 'قائمه العام' then
Devmfm:del(mustafa..'mfm:BanAll:')
Devmfm:del(mustafa..'mfm:MuteAll:')
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ حـذ٘ف قآإئمـَـهہ آلعـآم*")  
end
end
if SudoBot(msg) then
if txts[2] == 'الادمنيه العامين' or txts[2] == 'الادمنيه العام' or txtss[2] == 'الادمنيه العامين' or txtss[2] == 'الادمنيه العام' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ حـذ٘ف آلآډمـنيهہ آلعـآمين*")  
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ حـذ٘ف آلمـميٰزين عـآم*")  
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ حـذ٘ف آلمـډٍࢪآ۽ آلعـآمين*")  
Devmfm:del(mustafa..'mfm:ManagerAll:')
end
end
if mfmConstructor(msg) then
if txts[2] == 'المنشئين الاساسيين' or txtss[2] == 'المنشئين الاساسيين' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ حـذ٘ف آلمـنشـئيٰن آلآسآسيين*")  
Devmfm:del(mustafa..'mfm:BasicConstructor:'..msg.chat_id_)
end
end
if BasicConstructor(msg) then
if txts[2] == 'المنشئين' or txtss[2] == 'المنشئين' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ حـذ٘ف آلمـنشـئيٰن*")  
Devmfm:del(mustafa..'mfm:Constructor:'..msg.chat_id_)
end end
if Constructor(msg) then
if txts[2] == 'المدراء' or txtss[2] == 'المدراء' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ حـذ٘ف آلمـډٍࢪآ۽*")  
Devmfm:del(mustafa..'mfm:Managers:'..msg.chat_id_)
end 
if txts[2] == 'المنظفين' or txtss[2] == 'المنضفين' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ حـذ٘ف المنظفـيٰن*")  
Devmfm:del(mustafa..'mfm:Cleaner:'..msg.chat_id_)
end end
if Manager(msg) then
if txts[2] == 'الادمنيه' or txtss[2] == 'الادمنيه' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ حـذ٘ف آلآډمـنيهہ*")  
Devmfm:del(mustafa..'mfm:Admins:'..msg.chat_id_)
end
end
if txts[2] == 'المطايه' or txtss[2] == 'المطايه' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ حـذ٘ف آلمـطآيٰـه*")  
Devmfm:del(mustafa..'User:Donky:'..msg.chat_id_)
end
if txts[2] == 'الرابط' or txtss[2] == 'الرابط' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ حـذ٘ف رابط آلَمـجـ̨مـۈعة*")  
Devmfm:del(mustafa.."mfm:Groups:Links"..msg.chat_id_)
end
if txts[2] == 'المميزين' or txtss[2] == 'المميزين' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ حـذ٘ف آلمـميٰزين*")  
Devmfm:del(mustafa..'mfm:VipMem:'..msg.chat_id_)
end
if txts[2] == 'المكتومين' or txtss[2] == 'المكتومين' then
Devmfm:del(mustafa..'mfm:Muted:'..msg.chat_id_)
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ حـذ٘ف آلمـڪتومـيٰن*")  
end
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ حـذ٘ف المقيدين*")  
end
if txts[2] == 'قائمه المنع' or txtss[2] == 'قائمه المنع' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ حـذ٘ف قآإئمـَـهہ المنع*")  
Devmfm:del(mustafa..'mfm:Filters:'..msg.chat_id_)
end
if txts[2] == 'قوائم المنع' or txtss[2] == 'قوائم المنع' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ حـذ٘ف قوائم المنع*")  
Devmfm:del(mustafa..'mfm:Filters:'..msg.chat_id_)
...
Devmfm:del(mustafa.."mfm:FilterAnimation"..msg.chat_id_)
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ حـذ٘ف قآإئمـَـهہ منع المتحركات*")  
end
if txts[2] == 'قائمه منع الصور' or txtss[2] == 'قائمه منع الصور' then     
Devmfm:del(mustafa.."mfm:FilterPhoto"..msg.chat_id_)
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ حـذ٘ف قآإئمـَـهہ منع الصور*")  
end
if txts[2] == 'قائمه منع الملصقات' or txtss[2] == 'قائمه منع الملصقات' then     
Devmfm:del(mustafa.."mfm:FilterSteckr"..msg.chat_id_)
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","*✘ ∫ تــمِ حـذ٘ف قآإئمـَـهہ منع الملصقات*")  
end
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "*✘ ∫ تــمِ حذف ⏎ ❨ قآإئمـَـهہ المنع • المحظورين • المكتومين • الادمنيه • المميزين • المطايه ❩ بنجاح *\n ✓", 1, 'md')
end end
if text and text:match("^حذف جميع الرتب$") and ChCheck(msg) or text and text:match("^مسح جميع الرتب$") and ChCheck(msg) or text and text:match("^تنزيل جميع الرتب$") and ChCheck(msg) then
if not mfmConstructor(msg) then
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ لمنشئ آلَمـجـ̨مـۈعة فقط', 1, 'md')
else
...
Devmfm:del(mustafa..'mfm:VipMem:'..msg.chat_id_)
Devmfm:del(mustafa..'User:Donky:'..msg.chat_id_)
Dev_mfm(msg.chat_id_, msg.id_, 1, "*✘ ∫ تــمِ حذف جميع الرتب التاليه ⏎ * ❨ "..basicconstructort..''..constructort..''..Managerst..''..adminst..''..vipmemt..''..donkyt.." ❩ بنجاح \n ✓", 1, 'md')
else
Dev_mfm(msg.chat_id_, msg.id_, 1, "*✘ ∫ لاتوجد رتب هنـآ*", 1, 'md')
end 
end 
end
if Admin(msg) then 
...
local TXTE = "*✘ ∫ آعـډآډآت آلَمـجـ̨مـۈعة ⏎ ⥡ *\n┉┉┉┉ EB ┉┉┉┉\n"
.."*✘ ∫ الروابط ⏎ * "..mute_links.."\n"
.."*✘ ∫ المعرف ⏎* "..lock_tag.."\n"
.."*✘ ∫ البوتات ⏎* "..lock_bots.."\n"
.."*✘ ∫ المتحركه ⏎* "..mute_gifs.."\n"
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ حفظ قوانين آلَمـجـ̨مـۈعة', 1, 'md')
return false   
end
if text and text:match("^ضع قوانين$") and ChCheck(msg) or text and text:match("^وضع قوانين$") and ChCheck(msg) then
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ آٍࢪسۧل لي القوانين الان', 1, 'md')
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '*✘ ∫ آٍࢪسۧل لي الكلمه لزخرفتها *\n*يمكنك الزخرفة باللغه { en } ~ { ar }* ', 1, 'md')
end
end
if not Devmfm:get(mustafa..'mfm:Zrf:mfm'..msg.chat_id_) then
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ قم بآٍࢪسۧل اسمين لحساب نسبة الحب بينهما كمثال ⏎ جاك وروز', 1, 'md')
end
end
if text and text ~= "نسبه الحب" and text ~= "نسبة الحب" and Devmfm:get(mustafa..'LoveNsba:mfm'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ الغاء امر نسبة الحب ', 1, 'md')
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ قم بآٍࢪسۧل اسمين لحساب نسبة الكره بينهما كمثال ⏎ جاك وروز', 1, 'md')
end
end
...
if text and text == 'الغاء' then 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ الغاء امر نسبة الكره ', 1, 'md')
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ قم بآٍࢪسۧل اسم الشخص لقياس نسبة رجولته كمثال ⏎ جاك', 1, 'md')
end
end
...
if text and text == 'الغاء' then 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ الغاء امر نسبة الرجوله ', 1, 'md')
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ قم بآٍࢪسۧل اسم الشخص لقياس نسبة انوثته كمثال ⏎ روز', 1, 'md')
end
end
...
if text and text == 'الغاء' then 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ الغاء امر نسبة الانوثه ', 1, 'md')
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ قم بآٍࢪسۧل اسم الشخص لقياس نسبة غبائه كمثال ⏎ جاك او روز', 1, 'md')
end
end
...
if text and text == 'الغاء' then 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ الغاء امر نسبة الغباء ', 1, 'md')
...
local Text ='*✘ ∫ تــمِ اختيار المقطع الصوتي لك*'
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✘ Escobar Team .',url="t.me/TEAM_Escobar"}},
}
...
if text == "الفـيٰديو" or text == "الفـيٰديوهات" then if Devmfm:get(mustafa..'mfm:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفوله' else mute_video = 'مفتوحه' end local mustafaTEAM = "\n" .."✘ ∫ الفـيٰديو ⏎ "..mute_video.."\n" Dev_mfm(msg.chat_id_, msg.id_, 1, mustafaTEAM, 1, 'md') end
...
if data.message_ == "CHAT_ADMIN_REQUIRED" then
send(msg.chat_id_,msg.id_,"✘ ∫ ليست لدي صلاحية تغير معلومات آلَمـجـ̨مـۈعة يرجى التحقق من الصلاحيات")  
else
local mustafaTEAM = '✘ ∫ آهـلُِآ عٍزْيـــــــّــزْي ⏎ '..mfmRank(msg)..' \n✘ ∫ تــمِ تغير اسم آلَمـجـ̨مـۈعة'
mfmmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, mustafaTEAM, 14, string.len(msg.sender_user_id_))
end
end,nil) 
end
...
send(msg.chat_id_, msg.id_,"✘ ∫ عــــــــذرآ البوت ليس ادمن يرجى ترقيتي والمحاوله لاحقا") 
...
Dev_mfm(msg.chat_id_,msg.id_, 1, '✘ ∫ آٍࢪسۧل صورة آلَمـجـ̨مـۈعة الان', 1, 'md')
Devmfm:set(mustafa..'mfm:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
if text and text:match("^حذف الصوره$") and ChCheck(msg) or text and text:match("^مسح الصوره$") and ChCheck(msg) then
https.request("https://api.telegram.org/bot"..TokenBot.."/deleteChatPhoto?chat_id="..msg.chat_id_) 
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ حذف صورة آلَمـجـ̨مـۈعة")  
return false  
end
if Manager(msg) then
...
local mustafaTEAM = '✘ ∫ آهـلُِآ عٍزْيـــــــّــزْي ⏎ '..mfmRank(msg)..' \n✘ ∫ تــمِ الغاء تثبيت الرساله'
mfmmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, mustafaTEAM, 14, string.len(msg.sender_user_id_))
return false  
end
if data.code_ == 6 then
send(msg.chat_id_,msg.id_,"✘ ∫ انا لست ادمن هنـآ يرجى ترقيتي ادمن ثم اعد المحاوله")  
return false  
end
if data.message_ == "CHAT_ADMIN_REQUIRED" then
...
local mustafaTEAM = '✘ ∫ آهـلُِآ عٍزْيـــــــّــزْي ⏎ '..mfmRank(msg)..' \n✘ ∫ تــمِ اعادة تثبيت الرساله'
mfmmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, mustafaTEAM, 14, string.len(msg.sender_user_id_))
end end
end
if text == 'طرد المحذوفـيٰن' or text == 'مسح المحذوفـيٰن' or text == 'طرد الحسابات المحذوفه' or text == 'حذف المحذوفـيٰن' then  
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ طرد المحذوفـيٰن")  
end,nil)
end
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ حذف المحظورين")  
end
end
...
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub("-100","")},function(arg,data) 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ آلَمـجـ̨مـۈعة ⏎ ❨ '..dp.title_..' ❩\n✘ ∫ الايدي ⏎ ❨ '..msg.chat_id_..' ❩\n✘ ∫ عدد الاعضاء ⏎ ❨ *'..data.member_count_..'* ❩\n✘ ∫ عدد الادمنيه ⏎ ❨ *'..data.administrator_count_..'* ❩\n✘ ∫ عدد المطرودين ⏎ ❨ *'..data.kicked_count_..'* ❩\n✘ ∫ عدد المكتومين ⏎ ❨ *'..Muted..'* ❩\n✘ ∫ عدد رسائل آلَمـجـ̨مـۈعة ⏎ ❨ *'..(msg.id_/2097152/0.5)..'* ❩\n┉┉┉┉ EB ┉┉┉┉\n', 1, 'md') 
end,nil)
end,nil)
end
...
Dev_mfm(Text[2], 0, 1, "✘ ∫ بامر المطور تــمِ مغادرة هذه آلَمـجـ̨مـۈعة ", 1, "md")  
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ وضع عدد الاعضاء ⏎ *'..Num..'* عضــوُ', 1, 'md')
end
if text == 'تفعيل البوت الخدمي' then 
if not SecondSudo(msg) then
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ للمطور الاساسي فقط', 1, 'md')
else 
local mustafaTEAM = '✘ ∫ آهـلُِآ عٍزْيـــــــّــزْي ⏎ '..mfmRank(msg)..' \n✘ ∫ تــمِ تفعيل البوت الخدمي'
mfmmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, mustafaTEAM, 14, string.len(msg.sender_user_id_))
...
local mustafaTEAM = '✘ ∫ آهـلُِآ عٍزْيـــــــّــزْي ⏎ '..mfmRank(msg)..' \n✘ ∫ تــمِ تعطيل البوت الخدمي'
mfmmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, mustafaTEAM, 14, string.len(msg.sender_user_id_))
Devmfm:set(mustafa..'mfm:Lock:FreeBot'..mustafa,true) 
end 
end
if ChatType == 'sp' or ChatType == 'gp'  then
if text == 'تفعيل الالعاب' and Manager(msg) and ChCheck(msg) or text == 'تفعيل آللعبّــهہ 🎮' and Manager(msg) and ChCheck(msg) then   
local mustafaTEAM = '✘ ∫ آهـلُِآ عٍزْيـــــــّــزْي ⏎ '..mfmRank(msg)..' \n✘ ∫ تــمِ تفعيل الالعاب بنجاح'
mfmmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, mustafaTEAM, 14, string.len(msg.sender_user_id_))
Devmfm:del(mustafa..'mfm:Lock:Games'..msg.chat_id_) 
end
if text == 'تعطيل الالعاب' and Manager(msg) and ChCheck(msg) or text == 'تعطيل آللعبّــهہ 🎮' and Manager(msg) and ChCheck(msg) then  
local mustafaTEAM = '✘ ∫ آهـلُِآ عٍزْيـــــــّــزْي ⏎ '..mfmRank(msg)..' \n✘ ∫ تــمِ تعطيل الالعاب بنجاح'
mfmmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, mustafaTEAM, 14, string.len(msg.sender_user_id_))
Devmfm:set(mustafa..'mfm:Lock:Games'..msg.chat_id_,true)  
end
if text == "تفعيل الرابط" or text == "تفعيل جلب الرابط" then 
if Admin(msg) then
local mustafaTEAM = '✘ ∫ آهـلُِآ عٍزْيـــــــّــزْي ⏎ '..mfmRank(msg)..' \n✘ ∫ تــمِ تفعيل جلب رابط آلَمـجـ̨مـۈعة'
mfmmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, mustafaTEAM, 14, string.len(msg.sender_user_id_))
...
if Admin(msg) then
local mustafaTEAM = '✘ ∫ آهـلُِآ عٍزْيـــــــّــزْي ⏎ '..mfmRank(msg)..' \n✘ ∫ تــمِ تعطيل جلب رابط آلَمـجـ̨مـۈعة'
mfmmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, mustafaTEAM, 14, string.len(msg.sender_user_id_))
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ آلَمـجـ̨مـۈعة بالتاكيد مـعـطله', 1, 'md')
else
ReplyStatus(msg,result.id_,"ReplyBy","✘ ∫ تــمِ تعطيل آلَمـجـ̨مـۈعة "..dp.title_)  
Devmfm:srem(mustafa.."mfm:Groups",msg.chat_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
...
Devmfm:set(mustafa.."mfm:Groups:Links"..msg.chat_id_,LinkGroup) 
if not Sudo(msg) then
SendText(DevId,"✘ ∫ تــمِ تعطيل مجموعه جديده ⏎ ⥡ \n┉┉┉┉ EB ┉┉┉┉\n✘ ∫ بواسطة ⏎ "..Name.."\n✘ ∫ اسم آلَمـجـ̨مـۈعة ⏎ ["..NameChat.."]\n✘ ∫ ايدي آلَمـجـ̨مـۈعة ⏎ ⥡ \n❨ `"..msg.chat_id_.."` ❩\n✘ ∫ رابط آلَمـجـ̨مـۈعة ⏎ ⥡\n❨ ["..LinkGroup.."] ❩\n┉┉┉┉ EB ┉┉┉┉\n✘ ∫ الوقت ⏎ "..os.date("%I:%M%p").."\n✘ ∫ التاريخ ⏎ "..os.date("%Y/%m/%d").."",0,'md')
end
end
end,nil)
end,nil)
...
if not Sudo(msg) then
SendText(DevId,"✘ ∫ هنـآك من بحاجه الى مساعده ⏎ ⥡ \n┉┉┉┉ EB ┉┉┉┉\n✘ ∫ الشخص ⏎ "..Name.."\n✘ ∫ اسم آلَمـجـ̨مـۈعة ⏎ ["..NameChat.."]\n✘ ∫ ايدي آلَمـجـ̨مـۈعة ⏎ ⥡ \n❨ `"..msg.chat_id_.."` ❩\n✘ ∫ رابط آلَمـجـ̨مـۈعة ⏎ ⥡\n❨ ["..LinkGroup.."] ❩\n┉┉┉┉ EB ┉┉┉┉\n✘ ∫ الوقت ⏎ "..os.date("%I:%M%p").."\n✘ ∫ التاريخ ⏎ "..os.date("%Y/%m/%d").."",0,'md')
end
end,nil)
end,nil)
end
...
local mustafaTEAM = '✘ ∫ آهـلُِآ عٍزْيـــــــّــزْي ⏎ '..mfmRank(msg)..' \n✘ ∫ آٍࢪسۧل لي سواء ⏎ ⥡ \n❨ ملف • ملصق • متحركه • صوره\n • فـيٰديو • بصمه • صوت • رساله ❩\n✘ ∫ للخروج آٍࢪسۧل ⏎ ( الغاء ) \n ✓'
mfmmoned(msg.chat_id_, msg.sender_user_id_, msg.id_, mustafaTEAM, 14, string.len(msg.sender_user_id_))
return false
end 
if Devmfm:get(mustafa.."mfm:Send:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ تــمِ الغاء امر الاذاعه بنجاح", 1, 'md')
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ تــمِ اذاعة "..mfmText.." بنجاح \n✘ ∫ ‏الى ⏎ ❨ "..#List.." ❩ مشترك \n ✓", 1, 'md')
Devmfm:del(mustafa.."mfm:Send:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ تــمِ اذاعة "..mfmText.." بالتثبيت \n✘ ∫ ‏فـيٰ ⏎ ❨ "..#List.." ❩ مجموعه \n ✓", 1, 'md')
Devmfm:del(mustafa.."mfm:Send:Gp:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ حسنا آٍࢪسۧل الكلمه لحذفها " ,  1, "md")
return false
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ حسنا آٍࢪسۧل الكلمه الان " ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local SetGpRed = Devmfm:get(mustafa..'mfm:Add:GpRed'..msg.sender_user_id_..''..msg.chat_id_..'')
if SetGpRed == 'SetGpRed' then
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ آٍࢪسۧل لي الرد سواء كان ⏎ ⥡\n❨ ملف • ملصق • متحركه • صوره\n • فـيٰديو • بصمه • صوت • رساله ❩\n✘ ∫ يمكنك اضافة الى النص ⏎ ⥡\n┉┉┉┉ EB ┉┉┉┉\n `#username` ↬ معرف المستخدم\n `#msgs` ↬ عدد الرسائل\n `#name` ↬ اسم المستخدم\n `#id` ↬ ايدي المستخدم\n `#stast` ↬ رتبة المستخدم\n `#edit` ↬ عدد السحكات\n┉┉┉┉ EB ┉┉┉┉\n✘ ∫ للخروج آٍࢪسۧل ⏎ ( الغاء )\n ✓" ,  1, "md")
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ حذف ردود المدير")  
return false
end
end
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ حذف ردود المطور")  
return false
end
end 
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ آٍࢪسۧل لي اسم البوت الان" ,  1, "md") 
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ تــمِ استعادة الكلايش الاصليه" ,  1, "md") 
end
if text == "تعيين الاوامر" and SecondSudo(msg) or text == "تعيين امر الاوامر" and SecondSudo(msg) then
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ آٍࢪسۧل كليشة (الاوامر) الان " ,  1, "md")
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ آٍࢪسۧل كليشة (م1) الان " ,  1, "md")
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ آٍࢪسۧل كليشة (م2) الان " ,  1, "md")
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ آٍࢪسۧل كليشة (م3) الان " ,  1, "md")
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ آٍࢪسۧل كليشة (م4) الان " ,  1, "md")
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ آٍࢪسۧل كليشة (م5) الان " ,  1, "md")
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ آٍࢪسۧل كليشة (م6) الان " ,  1, "md")
...
✘ ∫ رسائلي • حذف رسائلي • اسمي • معرفـيٰ 
✘ ∫ ايدي •ايديي • جهاتي • غنيلي • الالعاب 
✘ ∫ نقاطي • بيع نقاطي • القوانين • زخرفه 
✘ ∫ رابط الحذف • نزلني • اطردني • المطور 
✘ ∫ منو ضافني • مشاهدات المنشور • الرابط 
✘ ∫ ايدي آلَمـجـ̨مـۈعة • معلومات آلَمـجـ̨مـۈعة 
...
file:close() 
os.execute('unlink RUNmfm.sh;unlink mfm;chmod +x Escobar.sh;chmod +x Run;./Run')
else
...
Devmfm:set(mustafa..'mfm:NameBot',(Devmfm:get(mustafa..'Name:Bot') or 'اسكوبار'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
...
send(msg.chat_id_, msg.id_,'✘ ∫ تــمِ نقل ⏎ '..#Groups..' مجموعه\n✘ ∫ تــمِ نقل ⏎ '..#Users..' مشترك\n✘ ∫ من التحديث القديم الى التحديث الجديد')
end
if text == 'الملفات' then
Files = '\n✘ ∫ الملفات المفعله فـيٰ البوت ⏎ ⥡ \n┉┉┉┉ EB ┉┉┉┉\n'
i = 0
for v in io.popen('ls Files'):lines() do
if v:match(".lua$") then
i = i + 1
...
if i == 0 then
Files = '✘ ∫ لا توجد ملفات فـيٰ البوت'
end
...
if Get_info then
local TextS = "\n*✘ ∫ قآإئمـَـهہ ملفات متجر سورس اسكوبار*\n*✘ ∫ الملفات المتوفره حاليا ⏎ ⥡*\n┉┉┉┉ EB ┉┉┉┉\n"
local TextE = "┉┉┉┉ EB ┉┉┉┉\n*✘ ∫ علامة ⏎ (✔) تعني الملف مفعل*\n*✘ ∫ علامة ⏎ (✖️) تعني الملف مـعـطل*\n"
local NumFile = 0
...
send(msg.chat_id_,msg.id_,"*✘ ∫ تــمِ حذف جميع الملفات المفعله*")
end
...
send(msg.chat_id_, msg.id_,"\n✘ ∫ الملف ⏎ *"..FileName.."*\n✘ ∫ تــمِ تعطيله وحذفه من البوت بنجاح") 
dofile('Escobar.lua')  
else
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ حذف معلومات الترحيب', 1, 'md')   
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ تفعيل الترحيب عند اضافة البوت فـيٰ آلَمـجـ̨مـۈعة', 1, 'md')   
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ تعطيل الترحيب عند اضافة البوت فـيٰ آلَمـجـ̨مـۈعة', 1, 'md')   
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ آٍࢪسۧل لي نص الترحيب', 1, 'md') 
Devmfm:del(mustafa..'mfm:Text:BotWelcome')
Devmfm:del(mustafa..'mfm:Photo:BotWelcome')
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ تــمِ حفظ النص آٍࢪسۧل لي صورة الترحيب\n✘ ∫ آٍࢪسۧل ⏎ الغاء لحفظ النص فقط", 1, 'md')   
...
if text and text:match("^الغاء$") then 
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ تــمِ حفظ النص والغاء حفظ صورة الترحيب", 1, "md") 
Devmfm:del(mustafa.."mfm:Set:BotWelcome"..msg.sender_user_id_)    
return false
end 
if msg.content_.photo_ and msg.content_.photo_.sizes_[1] then   
Devmfm:set(mustafa.."mfm:Photo:BotWelcome",msg.content_.photo_.sizes_[1].photo_.persistent_id_)
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ تــمِ حفظ النص وصورة الترحيب", 1, 'md')   
Devmfm:del(mustafa.."mfm:Set:BotWelcome"..msg.sender_user_id_)   
end
return false
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ آٍࢪسۧل كليشة المطور الان ", 1, "md")
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ تــمِ حذف كليشة المطور", 1, "md")
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ تغيير كليشة الاشتراك الاجباري', 1, 'md')
end
...
local text = '✘ ∫ حسنا آٍࢪسۧل كليشة الاشتراك الجديده'  
Dev_mfm(msg.chat_id_, msg.id_, 1,text, 1, 'md') 
end
...
textt = "✘ ∫ تــمِ حذف كليشة الاشتراك الاجباري"
...
elseif result.content_.ID == "MessageVideo" then Media = 'الفـيٰديو'
elseif result.content_.ID == "MessageAnimation" then Media = 'المتحركه'
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,dp) 
local mfmname = '✘ ∫ آلَعضــوُ ⏎ ['..CatchName(dp.first_name_,15)..'](tg://user?id='..dp.id_..')'
local mfmid = '✘ ∫ ايديه ⏎ `'..dp.id_..'`'
local mfmtext = '✘ ∫ قام بالتعديل على '..Media
local mfmtxt = '┉┉┉┉ EB ┉┉┉┉\n✘ ∫ تعالو يامشرفـيٰن اكو مخرب'
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,abbas) 
local admins = abbas.members_  
text = '\n┉┉┉┉ EB ┉┉┉┉\n'
for i=0 , #admins do 
