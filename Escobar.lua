...
send(chat,msg.id_,"✘ ∫ عــــــــذرآ الملف ليس بصيغة ⏎ Json يرجى رفع الملف الصحيح")
end
...
print('تــمِ رفع منشئين المجموعات')
end
end
...
send(chat,msg.id_,"✘ ∫ تــمِ رفع النسخه بنجاح \n✘ ∫ تــمِ تفعيل جميع المجموعات \n✘ ∫ تــمِ استرجاع مشرفين المجموعات \n✘ ∫ تــمِ استرجاع اوامر القفل والفتح في جميع مجموعات البوت ")
end
...
send(msg.chat_id_,msg.id_,'✘ ∫ الشخص غير موجود هنـآ')   
return false  end
...
EditMsg(Chat_Id2, Msg_Id2, "✘ ∫ لا استطيع طرد مشرفين آلَمـجـ̨مـۈعة") 
return false  
end
if da and da.ID and da.ID == "Ok" then
ChatKick(data.chat_id_, data.sender_user_id_)
EditMsg(Chat_Id2, Msg_Id2, "✘ ∫ تــمِ طردك من آلَمـجـ̨مـۈعة") 
return false
end
end,nil)  
end
...
EditMsg(Chat_Id2, Msg_Id2, "✘ ∫ ليس لديك رتبه في البوت ⚠️🔰") 
else 
EditMsg(Chat_Id2, Msg_Id2, "✘ ∫ لا استطيع تنزيل ⚠️🔰 ⏎ "..IdRank(data.sender_user_id_, data.chat_id_)) 
end
end
end
...
EditMsg(Chat_Id2, Msg_Id2, "✘ ∫ *صاحب الحظ* ⏎ ["..UserName.."]\n✘ ∫ *مبّــروُڪ لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*")
end
if DataText == '/NoRolet' then
Devmfm:del(mustafa..'mfm:ListRolet'..data.chat_id_) 
Devmfm:del(mustafa.."mfm:NumRolet"..data.chat_id_..data.sender_user_id_) 
Devmfm:del(mustafa.."mfm:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
EditMsg(Chat_Id2, Msg_Id2, "✘ ∫ تــمِ الغاء آللعبّــهہ 🎮 لاعادة اللعب ارسل الالعاب") 
end
if DataText == '/ListRolet' then
local List = Devmfm:smembers(mustafa..'mfm:ListRolet'..data.chat_id_) 
local Text = '✘ ∫ قآإئمـَـهہ الاعبين ⏎ ⥡\n┉┉┉┉ EB ┉┉┉┉\n' 
...
if #List == 0 then
t = "✘ ∫ لاتوجد اوامر مضافه في آلَمـجـ̨مـۈعة"
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ تــمِ حذف الاوامر المضافه في آلَمـجـ̨مـۈعة", 1, 'html')
end
...
t = "✘ ∫ قآإئمـَـهہ الصلاحيات المضافه ⏎ ⥡ \n┉┉┉┉ EB ┉┉┉┉\n"
for k,v in pairs(List) do
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ تستطيع اضافة صلاحية ( عضــوُ • مميز  • ادمن )\n✘ ∫ ارسال نوع الصلاحيه مره اخرى", 1, 'html')
return false
end
end
if text == "ادمن" then
if not Manager(msg) then 
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ تستطيع اضافة صلاحية ( عضــوُ • مميز )\n✘ ∫ ارسال نوع الصلاحيه مره اخرى", 1, 'html')
return false
end
end
if text == "مميز" then
if not Admin(msg) then
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ تستطيع اضافة صلاحية ( عضــوُ )\n✘ ∫ ارسال نوع الصلاحيه مره اخرى", 1, 'html')
return false
end
end
...
local mrmfm = Devmfm:get(mustafa.."Comd:New:rt:mfm:"..DEV_ABBAS..msg.chat_id_)
if mrmfm == "مميز" and VipMem(msg) then
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ آلَعضــوُ ⏎ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'TEAM_Escobar')..')'..' ❩\n✘ ∫ تــمِ تنزيله ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
...
local mrmfm = Devmfm:get(mustafa.."Comd:New:rt:mfm:"..text1[2]..msg.chat_id_)
if mrmfm == "مميز" and VipMem(msg) then
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ آلَعضــوُ ⏎ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'TEAM_Escobar')..')'..' ❩\n✘ ∫ تــمِ تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
if SecondSudo(msg) then 
local Sudo_Welcome = '✘ ∫ آهـلُِآ بك مجددا عٍزْيـــــــّــزْي المطور \n✘ ∫ اليك الازرار الخاصه بتعديل وتغيير كلايش سورس اسكوبار فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ آلَعضــوُ قام بحظر البوت لا تستطيع ارسال الرسائل له', 1, 'md')
return false  
end 
if text then
...
if ChatType == 'pv' then
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ لاتستطيع تفعيلي هنـآ يرجى اضافتي في مجموعه اولا', 1, 'md')
return false
end
if ChatType ~= 'sp' then
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ آلَمـجـ̨مـۈعة عاديه وليست خارقه لا تستطيع تفعيلي يرجى ان تضع سجل رسائل آلَمـجـ̨مـۈعة ضاهر وليس مخفي ومن بعدها يمكنك رفعي ادمن ثم تفعيلي', 1, 'md')
return false
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ لا تستطيع تفعيل هذه آلَمـجـ̨مـۈعة بسبب تعطيل البوت الخدمي من قبل المطور الاساسي', 1, 'md') 
end 
end 
...
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","✘ ∫ الصوره التي ارسلتها تــمِ منعها من آلَمـجـ̨مـۈعة")  
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
end
end
...
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","✘ ∫ المتحركه التي ارسلتها تــمِ منعها من آلَمـجـ̨مـۈعة")  
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
end
end
...
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","✘ ∫ الملصق الذي ارسلته تــمِ منعه من آلَمـجـ̨مـۈعة")  
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
return false   
end
end
...
Text = '✘ ∫ آلَعضــوُ ⏎ '..GetName..' \n✘ ∫ قام بالتكرار المحدد تــمِ طرده '
...
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","✘ ∫ مــمـن̀ۈع الفشار في آلَمـجـ̨مـۈعة")  
end end
...
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","✘ ∫ مــمـن̀ۈع الكفر في آلَمـجـ̨مـۈعة") 
end end
...
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","✘ ∫ مــمـن̀ۈع التكلم بالطائفيه هنـآ") 
end end
if SecondSudo(msg) then
...
Dev_mfm( msg.chat_id_, msg.id_, 1,'✘ ∫ *المحيبس باليد رقم* ⏎ '..NUM..'\n✘ ∫ *مبّــروُڪ لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, "md") 
...
send(msg.chat_id_, msg.id_, '✘ ∫ عــــــــذرآ لا يمكنك وضع معرف حسابات في الاشتراك')
return false  end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.is_supergroup_ == true then
send(msg.chat_id_, msg.id_, '✘ ∫ عــــــــذرآ لا يمكنك وضع معرف مجموعه في الاشتراك')
return false  end
...
send(msg.chat_id_, msg.id_,'✘ ∫ عــــــــذرآ البوت ليس ادمن في القناة')
end
return false  
end
end,nil)
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ جلب رابط آلَمـجـ̨مـۈعة معطل', 1, 'md')
end
end
...
if text ==  'حذف رسائلي' and ChCheck(msg) or text ==  'مسح رسائلي' and ChCheck(msg) then Devmfm:del(mustafa..'mfm:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_) Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ حذف جميع رسائلك', 1, 'md') end
if text ==  'حذف نقاطي' and ChCheck(msg) or text ==  'مسح نقاطي' and ChCheck(msg) then Devmfm:del(mustafa..'mfm:GamesNumber'..msg.chat_id_..msg.sender_user_id_) Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ حذف جميع نقاطك', 1, 'md') end
...
mustafaTEAM = '✘ ∫ مبّــروُڪ لقد ربحت في آللعبّــهہ 🎮 \n✘ ∫ ارسل ⏎ سمايلات للعب مره اخرى'
Dev_mfm(msg.chat_id_, msg.id_, 1,mustafaTEAM, 1, 'md')
...
if not Devmfm:get(mustafa..'mfm:Lock:Games'..msg.chat_id_) then
Devmfm2 = {'النيل','14','الفم','11','30','بوتين','ستيف جوبر','باريس','10','النمل','حرف الواو','الشعر','سحاب','الاسم','ذهب','حرف الام','العزائم','انسات','المنجنيق','اسيا','6','الاسد','مهر','الدولفين','اوروبا','الزئبق','لندن','الانسان','اسكوبار','خديجه',}
name = Devmfm2[math.random(#Devmfm2)]
...
Dev_mfm(msg.chat_id_, msg.id_, 1,'✘ ∫ آهـلُِآ بك عٍزْيـــــــّــزْي في لعبة التخمين ⏎ ⥡\n ┉┉┉┉ EB ┉┉┉┉\n✘ ∫ سيتم تخمين عدد ما بين الـ1 والـ20 اذا تعتقد انك تستطيع الفوز جرب واللعب الان .\n✘ ∫ ملاحظه لديك ثلاث محاولات فقط فكر قبل ارسال تخمينك !', 1, 'md')
...
if text == "1" then
Text = "✘ ∫ لا استطيع بدء آللعبّــهہ 🎮 بلاعب واحد فقط"
else
...
local Text = "✘ ∫ تــمِ ادخال المعرف ⏎ ["..text.."] وتبقى ⏎ "..CountUser.." لاعبين ليكتمل العدد ارسل المعرف الاخر"
keyboard = {} 
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ عــــــــذرآ الالعاب معطله في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1,'✘ ∫ تــمِ بيع '..(Devmfm:get(mustafa..'mfm:GamesNumber'..msg.chat_id_..msg.sender_user_id_))..' من نقاطك\n✘ ∫ كل نقطه تساوي 50 رساله', 'md')
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ عــــــــذرآ هذه الخاصيه معطله ', 1, 'md')
return false
end
...
local user_msgs = Devmfm:get(mustafa..'mfm:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ عدد رسائلك هنـآ ⏎ *❨ "..user_msgs.." ❩*", 1, 'md')
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ آلَعضــوُ غير موجود في آلَمـجـ̨مـۈعة', 1, 'md') 
end 
end 
...
ReplyStatus(msg,result.id_,"Reply","✘ ∫ تــمِ تنزيله من ⏎ ⥡\n~ ( "..secondsudo..''..sudobot..''..managerall..''..adminall..''..vpall..''..basicconstructor..''..constructor..''..manager..''..admins..''..vipmem..''..cleaner.." ) ~")  
else 
...
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ آلمـطوٍࢪين الثانويين")  
end 
...
ReplyStatus(msg,result.id_,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ آلمـطوٍࢪين الثانويين")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ آلمـطوٍࢪين الثانويين")  
end
--     Rem SecondSudo     --
if text ==('حذف مطور ثانوي') or text ==('تنزيل مطور ثانوي') and ChCheck(msg) then
function prom_reply(extra, result, success)
Devmfm:srem(mustafa..'mfm:SecondSudo:',result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ آلمـطوٍࢪين الثانويين")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
...
if result.id_ then
Devmfm:srem(mustafa..'mfm:SecondSudo:',result.id_)
ReplyStatus(msg,result.id_,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ المطورين الثانويين")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ آلمـطوٍࢪين الثانويين")  
end end
--       Set SudoBot      --
if SecondSudo(msg) then
...
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ آلمـطوٍࢪين")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),sudo_reply)
...
ReplyStatus(msg,result.id_,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ المطورين")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ آلمـطوٍࢪين")  
end
--       Rem SudoBot      --
if text ==('حذف مطور') or text ==('تنزيل مطور') and ChCheck(msg) then
function prom_reply(extra, result, success)
Devmfm:srem(mustafa..'mfm:SudoBot:',result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ آلمـطوٍࢪين")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
Devmfm:srem(mustafa..'mfm:SudoBot:',result.id_)
ReplyStatus(msg,result.id_,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ آلمـطوٍࢪين")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ آلمـطوٍࢪين")  
end end
--      Set ManagerAll    --
if SudoBot(msg) then
...
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ المدراء العامين")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
...
ReplyStatus(msg,result.id_,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ المدراء العامين")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ المدراء العامين")  
end
--      Rem ManagerAll    --
if text ==('تنزيل مدير عام') and ChCheck(msg) then
function prom_reply(extra, result, success)
Devmfm:srem(mustafa..'mfm:ManagerAll:',result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ المدراء العامين")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
Devmfm:srem(mustafa..'mfm:ManagerAll:',result.id_)
ReplyStatus(msg,result.id_,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ المدراء العامين")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ المدراء العامين")  
end end
--      Set adminall      --
...
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ الادمنيه العامين")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),raf_reply)
...
ReplyStatus(msg,result.id_,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ الادمنيه العامين")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ الادمنيه العامين")  
end
--      Rem adminall      --
if text ==('تنزيل ادمن عام') and ChCheck(msg) then
function prom_reply(extra, result, success)
Devmfm:srem(mustafa..'mfm:AdminAll:',result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ الادمنيه العامين")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
Devmfm:srem(mustafa..'mfm:AdminAll:',result.id_)
ReplyStatus(msg,result.id_,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ الادمنيه العامين")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ الادمنيه العامين")  
end end
--       Set Vipall       --
...
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ المميزين العام")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),raf_reply)
...
ReplyStatus(msg,result.id_,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ المميزين العام")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ المميزين العام")  
end
--       Rem Vipall       --
if text ==('تنزيل مميز عام') and ChCheck(msg) then
function prom_reply(extra, result, success)
Devmfm:srem(mustafa..'mfm:VipAll:',result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ المميزين العام")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
Devmfm:srem(mustafa..'mfm:VipAll:',result.id_)
ReplyStatus(msg,result.id_,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ المميزين العام")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ المميزين العام")  
end end
...
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ منشئ اساسي")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),raf_reply)
...
ReplyStatus(msg,result.id_,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ منشئ اساسي")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ منشئ اساسي")  
end
--  Rem BasicConstructor  --
if text ==('تنزيل منشئ اساسي') and ChCheck(msg) then
function prom_reply(extra, result, success)
Devmfm:srem(mustafa..'mfm:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ تنزيله منشئ اساسي")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
Devmfm:srem(mustafa..'mfm:BasicConstructor:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","✘ ∫ تــمِ تنزيله منشئ اساسي")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ تنزيله منشئ اساسي")  
end end
...
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ آلمـنشـئيٰن")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),raf_reply)
...
ReplyStatus(msg,result.id_,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ آلمـنشـئيٰن")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ آلمـنشـئيٰن")  
end
--    Rem  Constructor    --
if text ==('تنزيل منشئ') and ChCheck(msg) then
function prom_reply(extra, result, success)
Devmfm:srem(mustafa..'mfm:Constructor:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ آلمـنشـئيٰن")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
Devmfm:srem(mustafa..'mfm:Constructor:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ آلمـنشـئيٰن")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ آلمـنشـئيٰن")  
end 
end
--      Set Manager       --
if Constructor(msg) then
...
function prom_reply(extra, result, success)
Devmfm:sadd(mustafa..'mfm:Managers:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ المدراء")  
end  
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
Devmfm:sadd(mustafa..'mfm:Managers:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ آلمـډٍࢪآ۽")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ آلمـډٍࢪآ۽")  
end
--       Rem Manager      --
if text ==('تنزيل مدير') and ChCheck(msg) then
function prom_reply(extra, result, success)
Devmfm:srem(mustafa..'mfm:Managers:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ آلمـډٍࢪآ۽")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
Devmfm:srem(mustafa..'mfm:Managers:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ آلمـډٍࢪآ۽")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ آلمـډٍࢪآ۽")  
end 
--       Set Cleaner      --
if text ==('رفع منظف') and ChCheck(msg) then
function prom_reply(extra, result, success)
Devmfm:sadd(mustafa..'mfm:Cleaner:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ المنظفين")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
ReplyStatus(msg,result.id_,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ المنظفين")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ المنظفين")  
end
--       Rem Cleaner      --
if text ==('تنزيل منظف') and ChCheck(msg) then
function prom_reply(extra, result, success)
Devmfm:srem(mustafa..'mfm:Cleaner:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ المنظفين")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
Devmfm:srem(mustafa..'mfm:Cleaner:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ المنظفين")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ المنظفين")  
end end
--       Set admin        --
if Manager(msg) then
...
Dev_mfm(msg.chat_id_, msg.id_, 1,'✘ ∫ لاتستطيع رفع احد وذالك بسبب تعطيل الرفع من قبل آلمـنشـئيٰن', 1, 'md')
return false
end
Devmfm:sadd(mustafa..'mfm:Admins:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ آلآډمـنيهہ")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
Devmfm:sadd(mustafa..'mfm:Admins:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ آلآډمـنيهہ")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ آلآډمـنيهہ")  
end
--        Rem admin       --
if text ==('تنزيل ادمن') and ChCheck(msg) then
function prom_reply(extra, result, success)
Devmfm:srem(mustafa..'mfm:Admins:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ آلآډمـنيهہ")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
Devmfm:srem(mustafa..'mfm:Admins:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ آلآډمـنيهہ")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ آلآډمـنيهہ")  
end end
--       Set Vipmem       --
if Admin(msg) then
...
Devmfm:sadd(mustafa..'mfm:VipMem:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ آلمـميٰزين")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
Devmfm:sadd(mustafa..'mfm:VipMem:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ آلمـميٰزين")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ آلمـميٰزين")  
end
--       Rem Vipmem       --
if text ==('تنزيل مميز') and ChCheck(msg) then
function prom_reply(extra, result, success)
Devmfm:srem(mustafa..'mfm:VipMem:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ آلمـميٰزين")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
Devmfm:srem(mustafa..'mfm:VipMem:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ آلمـميٰزين")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ آلمـميٰزين")  
end end 
if BasicConstructor(msg) then
...
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ مشرف في آلَمـجـ̨مـۈعة")  
else
...
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ تنزيله من مشرفين آلَمـجـ̨مـۈعة")  
else
Dev_mfm(msg.chat_id_, msg.id_, 1,'✘ ∫ ليست لدي صلاحية اضافة مشرفين جدد يرجى التحقق من الصلاحيات', 1, 'md')
end
end
...
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ مشرف في جميع الصلاحيات")  
else
Dev_mfm(msg.chat_id_, msg.id_, 1,'✘ ∫ ليست لدي صلاحية اضافة مشرفين جدد يرجى التحقق من الصلاحيات', 1, 'md')
end
end
...
send(msg.chat_id_,msg.id_,"✘ ∫ لا استطيع طرد مشرفين آلَمـجـ̨مـۈعة") 
return false  
end
ChatKick(result.chat_id_, result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ طرده من آلَمـجـ̨مـۈعة")  
end,nil)
end
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
...
ReplyStatus(msg,result.id_,"Reply","✘ ∫ تــمِ طرده من آلَمـجـ̨مـۈعة")  
end,nil)
end
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ طرده من آلَمـجـ̨مـۈعة")  
end,nil)
end
end
end 
...
if dp and dp.code_ and dp.code_ == 400 and dp.message_ == "USER_ADMIN_INVALID" then 
send(msg.chat_id_,msg.id_,"✘ ∫ لا استطيع حظر مشرفين آلَمـجـ̨مـۈعة") 
return false  
end
ChatKick(result.chat_id_, result.sender_user_id_)
...
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ المطايه") 
...
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ المطايه") 
end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,donky_by_reply)
end end
if Admin(msg) then
...
text = "✘ ∫ قآإئمـَـهہ المنع ⏎ ⥡ \n┉┉┉┉ EB ┉┉┉┉\n"
for k, v in pairs(List) do
text = text..k..'~ ❨ '..v..' ❩\n'
end
if #List == 0 then
text = "✘ ∫ لا توجد كلمات مــمـن̀ۈعه"
end
Dev_mfm(msg.chat_id_, msg.id_, 1, text, 1, 'md')
end
end 
...
if #MuteAll ~= 0 then 
text = text.."✘ ∫ قآإئمـَـهہ المكتومين عام ⏎ ⥡ \n┉┉┉┉ EB ┉┉┉┉\n"
...
local List = Devmfm:smembers(mustafa..mfm)
text = "✘ ∫ قآإئمـَـهہ الادمنيه العامين ⏎ ⥡ \n┉┉┉┉ EB ┉┉┉┉\n"
for k,v in pairs(List) do
local username = Devmfm:get(mustafa..'Save:UserName'..v)
if username then
text = text..""..k.."~ : [@"..username.."]\n"
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ عــــــــذرآ الايدي معطل ', 1, 'md')
end
else
if Devmfm:get(mustafa.."mfm:AllIds:Text") then
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ التعديل بالفعل مقفل في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تعديل الميديا بالفعل مقفل في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الفارسيه بالفعل مقفله في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الفشار بالفعل مقفل في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
if LockText[2] == "الطائفيه" then
if Devmfm:get(mustafa..'mfm:Lock:Taf'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ قفل الطائفيه")  
Devmfm:del(mustafa..'mfm:Lock:Taf'..msg.chat_id_)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الطائفيه بالفعل مقفله في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الكفر بالفعل مقفل في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ التثبيت بالفعل مقفل في آلَمـجـ̨مـۈعة', 1, 'md')
end end end
end
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ ارسل رابط آلَمـجـ̨مـۈعة او رابط قناة آلَمـجـ̨مـۈعة', 1, 'md')
...
LinkGroup = LinkGp.result
Devmfm:set(mustafa.."mfm:Groups:Links"..msg.chat_id_,LinkGroup) 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ انشاء رابط جديد ارسل ⏎ الرابط', 1, 'md')
else
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ التعديل بالفعل مفتوح في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تعديل الميديا بالفعل مفتوح في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الفارسيه بالفعل مفتوحه في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الفشار بالفعل مفتوح في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
if UnLockText[2] == "الطائفيه" then
if not Devmfm:get(mustafa..'mfm:Lock:Taf'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ فتح الطائفيه")  
Devmfm:set(mustafa..'mfm:Lock:Taf'..msg.chat_id_,true)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الطائفيه بالفعل مفتوحه في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الكفر بالفعل مفتوح في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ التثبيت بالفعل مفتوح في آلَمـجـ̨مـۈعة', 1, 'md')
end end end
end
end
if Admin(msg) then
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الدردشه بالفعل مقفله في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الاونلاين بالفعل مقفل في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الصور بالفعل مقفله في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الكلايش بالفعل مقفله في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الدخول بالفعل مقفل في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
if LockText[2] == "الفيديو" then
if not Devmfm:get(mustafa..'mfm:Lock:Videos'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ قفل الفيديو")  
Devmfm:set(mustafa..'mfm:Lock:Videos'..msg.chat_id_,true)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الفيديو بالفعل مقفل في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ المتحركه بالفعل مقفله في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الاغاني بالفعل مقفله في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الصوت بالفعل مقفل في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الروابط بالفعل مقفله في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ المواقع بالفعل مقفله في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ المعرفات بالفعل مقفله في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الملفات بالفعل مقفله في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الهاشتاك بالفعل مقفل في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '️✘ ∫ الجهات بالفعل مقفله في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الشبكات بالفعل مقفله في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ العربيه بالفعل مقفله في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الانكليزيه بالفعل مقفله في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الملصقات بالفعل مقفله في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الماركداون بالفعل مقفل في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الاشعارات بالفعل مقفله في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ التوجيه بالفعل مقفل في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الدردشه بالفعل مفتوحه في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الصور بالفعل مفتوحه في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الكلايش بالفعل مفتوحه في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الدخول بالفعل مفتوح في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
if UnLockText[2] == "الفيديو" then
if Devmfm:get(mustafa..'mfm:Lock:Videos'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ فتح الفيديو")  
Devmfm:del(mustafa..'mfm:Lock:Videos'..msg.chat_id_)
else
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الفيديو بالفعل مفتوحه في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الملفات بالفعل مفتوحه في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الاونلاين بالفعل مفتوحه في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الماركداون بالفعل مفتوحه في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ المتحركه بالفعل مفتوحه في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الاغاني بالفعل مفتوحه في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الصوت بالفعل مفتوحه في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الروابط بالفعل مفتوحه في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ المواقع بالفعل مفتوحه في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ المعرفات بالفعل مفتوحه في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الهاشتاك بالفعل مفتوحه في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الجهات بالفعل مفتوحه في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الشبكات بالفعل مفتوحه في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ العربيه بالفعل مفتوحه في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الانكليزيه بالفعل مفتوحه في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الاشعارات بالفعل مفتوحه في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ الملصقات بالفعل مفتوحه في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ التوجيه بالفعل مفتوح في آلَمـجـ̨مـۈعة', 1, 'md')
end
end
end
end
...
if #admins == i then 
local a = '┉┉┉┉ EB ┉┉┉┉\n✘ ∫ *عدد آلبـوتآت هنـآ* ⏎ '..n..'\n'
local f = '✘ ∫ *عدد آلبـوتآت المرفوعه* ⏎ '..t..'\n✘ ∫ *ملاحضه علامة الـ*✯ *تعني ان البوت ادمن في هذه آلَمـجـ̨مـۈعة*'
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ حذف المطورين الثانويين")  
end
end
if SecondSudo(msg) then 
if txts[2] == 'المطورين' or txtss[2] == 'المطورين' then
Devmfm:del(mustafa..'mfm:SudoBot:')
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ حذف المطورين")  
end
if txts[2] == 'قائمه العام' or txtss[2] == 'قائمه العام' then
Devmfm:del(mustafa..'mfm:BanAll:')
Devmfm:del(mustafa..'mfm:MuteAll:')
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ حذف قآإئمـَـهہ العام")  
end
end
if SudoBot(msg) then
if txts[2] == 'الادمنيه العامين' or txts[2] == 'الادمنيه العام' or txtss[2] == 'الادمنيه العامين' or txtss[2] == 'الادمنيه العام' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ حذف الادمنيه العامين")  
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ حذف المميزين عام")  
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ حذف المدراء العامين")  
Devmfm:del(mustafa..'mfm:ManagerAll:')
end
end
if mfmConstructor(msg) then
if txts[2] == 'المنشئين الاساسيين' or txtss[2] == 'المنشئين الاساسيين' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ حذف المنشئين الاساسيين")  
Devmfm:del(mustafa..'mfm:BasicConstructor:'..msg.chat_id_)
end
end
if BasicConstructor(msg) then
if txts[2] == 'المنشئين' or txtss[2] == 'المنشئين' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ حذف المنشئين")  
Devmfm:del(mustafa..'mfm:Constructor:'..msg.chat_id_)
end end
if Constructor(msg) then
if txts[2] == 'المدراء' or txtss[2] == 'المدراء' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ حذف المدراء")  
Devmfm:del(mustafa..'mfm:Managers:'..msg.chat_id_)
end 
if txts[2] == 'المنظفين' or txtss[2] == 'المنظفين' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ حذف المنظفين")  
Devmfm:del(mustafa..'mfm:Cleaner:'..msg.chat_id_)
end end
if Manager(msg) then
if txts[2] == 'الادمنيه' or txtss[2] == 'الادمنيه' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ حذف الادمنيه")  
Devmfm:del(mustafa..'mfm:Admins:'..msg.chat_id_)
end
end
if txts[2] == 'المطايه' or txtss[2] == 'المطايه' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ حذف المطايه")  
Devmfm:del(mustafa..'User:Donky:'..msg.chat_id_)
end
if txts[2] == 'الرابط' or txtss[2] == 'الرابط' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ حذف رابط آلَمـجـ̨مـۈعة")  
Devmfm:del(mustafa.."mfm:Groups:Links"..msg.chat_id_)
end
if txts[2] == 'المميزين' or txtss[2] == 'المميزين' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ حذف المميزين")  
Devmfm:del(mustafa..'mfm:VipMem:'..msg.chat_id_)
end
if txts[2] == 'المكتومين' or txtss[2] == 'المكتومين' then
Devmfm:del(mustafa..'mfm:Muted:'..msg.chat_id_)
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ حذف المكتومين")  
end
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ حذف المقيدين")  
end
if txts[2] == 'قائمه المنع' or txtss[2] == 'قائمه المنع' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ حذف قآإئمـَـهہ المنع")  
Devmfm:del(mustafa..'mfm:Filters:'..msg.chat_id_)
end
if txts[2] == 'قوائم المنع' or txtss[2] == 'قوائم المنع' then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ حذف قوائم المنع")  
Devmfm:del(mustafa..'mfm:Filters:'..msg.chat_id_)
...
Devmfm:del(mustafa.."mfm:FilterAnimation"..msg.chat_id_)
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ حذف قآإئمـَـهہ منع المتحركات")  
end
if txts[2] == 'قائمه منع الصور' or txtss[2] == 'قائمه منع الصور' then     
Devmfm:del(mustafa.."mfm:FilterPhoto"..msg.chat_id_)
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ حذف قآإئمـَـهہ منع الصور")  
end
if txts[2] == 'قائمه منع الملصقات' or txtss[2] == 'قائمه منع الملصقات' then     
Devmfm:del(mustafa.."mfm:FilterSteckr"..msg.chat_id_)
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ حذف قآإئمـَـهہ منع الملصقات")  
end
end
end
...
Dev_mfm(msg.chat_id_,msg.id_, 1, '✘ ∫ ارسل صورة آلَمـجـ̨مـۈعة الان', 1, 'md')
...
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","✘ ∫ تــمِ طرد المحذوفين")  
end,nil)
end
...
if text and text:match("^معلومات آلَمـجـ̨مـۈعة$") and ChCheck(msg) or text and text:match("^عدد الاعضاء$") and ChCheck(msg) or text and text:match("^عدد الكروب$") and ChCheck(msg) or text and text:match("^عدد الادمنيه$") and ChCheck(msg) or text and text:match("^عدد المحظورين$") and ChCheck(msg) then
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ آلَمـجـ̨مـۈعة بالتاكيد معطله', 1, 'md')
else
...
local text =  [[
✘ ∫ آهـلُِآ بك في قآإئمـَـهہ الاوامر ⏎ ⥡ 
┉┉┉┉ EB ┉┉┉┉
✘ ∫ م1 ⏎ اوامر الحمايه
✘ ∫ م2 ⏎ اوامر الادمنيه
✘ ∫ م3 ⏎ اوامر المدراء
...
✘ ∫ الحظر • الكتم
┉┉┉┉ EB ┉┉┉┉
✘ ∫ آلآوآمـࢪ آلمـنشـئيٰن آلآسآسيين ⏎ ⥡
┉┉┉┉ EB ┉┉┉┉
✘ ∫ وضع لقب + اللقب
✘ ∫ تفعيل • تعطيل ⏎ الرفع
✘ ∫ رفع منشئ • تنزيل منشئ
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ تفعيل الترحيب عند اضافة البوت في آلَمـجـ̨مـۈعة', 1, 'md')   
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ تعطيل الترحيب عند اضافة البوت في آلَمـجـ̨مـۈعة', 1, 'md')   
...
Dev_mfm(msg.chat_id_, msg.id_, 1, "✘ ∫ تــمِ حفظ النص ارسل لي صورة الترحيب\n✘ ∫ ارسل ⏎ الغاء لحفظ النص فقط", 1, 'md')   
