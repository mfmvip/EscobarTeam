...
if GetInfo.ok == true then
if GetInfo.result.status == "creator" then
send(msg.chat_id_,msg.id_,'✘ ∫ مالك آلَمـجـ̨مـۈعة')   
return false  end 
if GetInfo.result.status == "member" then
send(msg.chat_id_,msg.id_,'✘ ∫ مجرد عضو هنـآ')   
return false  end
...
EditMsg(Chat_Id2, Msg_Id2, "✘ ∫  تــمِ تنزيلك من ⏎ ⥡\n~ ( "..constructor..''..Managers..''..admins..''..vipmem..''..cleaner..''..donky.."  ) ~⚠️🔰 \n " ) 
else 
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ عدد اعضاء آلَمـجـ̨مـۈعة اقل من ⏎ *'..(Devmfm:get(mustafa..'mfm:Num:Add:Bot') or 0)..'* عضو', 1, 'md')
return false
end
...
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ المطورين الثانويين")  
end 
...
ReplyStatus(msg,result.id_,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ المطورين الثانويين")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ المطورين الثانويين")  
end
--     Rem SecondSudo     --
if text ==('حذف مطور ثانوي') or text ==('تنزيل مطور ثانوي') and ChCheck(msg) then
function prom_reply(extra, result, success)
Devmfm:srem(mustafa..'mfm:SecondSudo:',result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ المطورين الثانويين")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ المطورين الثانويين")  
end end
--       Set SudoBot      --
if SecondSudo(msg) then
...
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ المطورين")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),sudo_reply)
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ المطورين")  
end
--       Rem SudoBot      --
if text ==('حذف مطور') or text ==('تنزيل مطور') and ChCheck(msg) then
function prom_reply(extra, result, success)
Devmfm:srem(mustafa..'mfm:SudoBot:',result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ المطورين")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
Devmfm:srem(mustafa..'mfm:SudoBot:',result.id_)
ReplyStatus(msg,result.id_,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ المطورين")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ المطورين")  
end end
--      Set ManagerAll    --
if SudoBot(msg) then
...
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ المنشئين")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),raf_reply)
...
ReplyStatus(msg,result.id_,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ المنشئين")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ المنشئين")  
end
--    Rem  Constructor    --
if text ==('تنزيل منشئ') and ChCheck(msg) then
function prom_reply(extra, result, success)
Devmfm:srem(mustafa..'mfm:Constructor:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ المنشئين")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
Devmfm:srem(mustafa..'mfm:Constructor:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ المنشئين")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ المنشئين")  
end 
end
--      Set Manager       --
if Constructor(msg) then
...
if result.id_ then
Devmfm:sadd(mustafa..'mfm:Managers:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ المدراء")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ المدراء")  
end
--       Rem Manager      --
if text ==('تنزيل مدير') and ChCheck(msg) then
function prom_reply(extra, result, success)
Devmfm:srem(mustafa..'mfm:Managers:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ المدراء")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
Devmfm:srem(mustafa..'mfm:Managers:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ المدراء")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ المدراء")  
end 
--       Set Cleaner      --
...
Devmfm:sadd(mustafa..'mfm:Admins:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ الادمنيه")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
Devmfm:sadd(mustafa..'mfm:Admins:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ الادمنيه")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ الادمنيه")  
end
--        Rem admin       --
if text ==('تنزيل ادمن') and ChCheck(msg) then
function prom_reply(extra, result, success)
Devmfm:srem(mustafa..'mfm:Admins:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ الادمنيه")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
Devmfm:srem(mustafa..'mfm:Admins:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ الادمنيه")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ الادمنيه")  
end end
--       Set Vipmem       --
if Admin(msg) then
...
Devmfm:sadd(mustafa..'mfm:VipMem:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ المميزين")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
Devmfm:sadd(mustafa..'mfm:VipMem:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ المميزين")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ ٍࢪفعـهہ في قآإئمـَـهہ المميزين")  
end
--       Rem Vipmem       --
if text ==('تنزيل مميز') and ChCheck(msg) then
function prom_reply(extra, result, success)
Devmfm:srem(mustafa..'mfm:VipMem:'..msg.chat_id_,result.sender_user_id_)
ReplyStatus(msg,result.sender_user_id_,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ المميزين")  
end 
if tonumber(tonumber(msg.reply_to_message_id_)) == 0 then
else
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),prom_reply)
...
if result.id_ then
Devmfm:srem(mustafa..'mfm:VipMem:'..msg.chat_id_,result.id_)
ReplyStatus(msg,result.id_,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ المميزين")  
else 
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ *المعرف غير صحيح*', 1, 'md')
end end 
resolve_username(username,promreply)
...
ReplyStatus(msg,user,"Reply","✘ ∫ تــمِ تنزيله من قآإئمـَـهہ المميزين")  
end end 
if BasicConstructor(msg) then
...
text = "✘ ∫ قآإئمـَـهہ المنشئين الاساسيين ⏎ ⥡ \n┉┉┉┉ EB ┉┉┉┉\n"
for k,v in pairs(List) do
local username = Devmfm:get(mustafa..'Save:UserName'..v)
if username then
text = text..""..k.."~ : [@"..username.."]\n"
...
text = "✘ ∫ قآإئمـَـهہ المدراء العامين ⏎ ⥡ \n┉┉┉┉ EB ┉┉┉┉\n"
for k,v in pairs(List) do
local username = Devmfm:get(mustafa..'Save:UserName'..v)
if username then
text = text..""..k.."~ : [@"..username.."]\n"
...
text = "✘ ∫ قآإئمـَـهہ المميزين العام ⏎ ⥡ \n┉┉┉┉ EB ┉┉┉┉\n"
for k,v in pairs(List) do
local username = Devmfm:get(mustafa..'Save:UserName'..v)
if username then
text = text..""..k.."~ : [@"..username.."]\n"
...
mustafagp1 = '\n✘ ∫ تــمِ حذف ⏎ { '..w..' } مجموعه بسبب تنزيل البوت الى عضو'
end
...
local TXTE = "✘ ∫ اعدادات آلَمـجـ̨مـۈعة ⏎ ⥡\n┉┉┉┉ EB ┉┉┉┉\n"
.."✘ ∫ الروابط ⏎ "..mute_links.."\n"
.."✘ ∫ المعرف ⏎ "..lock_tag.."\n"
.."✘ ∫ البوتات ⏎ "..lock_bots.."\n"
.."✘ ∫ المتحركه ⏎ "..mute_gifs.."\n"
...
Dev_mfm(msg.chat_id_, msg.id_, 1, '✘ ∫ تــمِ وضع عدد الاعضاء ⏎ *'..Num..'* عضو', 1, 'md')
end
